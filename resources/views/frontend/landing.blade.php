...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:38:09 GMT -->
...
<body>
                        ...
                        <div class="position-relative">
                            ...
                            <div class="device-browser-frame">
                                <div class="js-img-comp-container hs-img-comp-container">
                                    <img class="hs-img-comp hs-img-comp-a" src="assets/img/1618x1010/img1.jpg"
                                        alt="Image Description">

                                    <div class="js-img-comp-wrapper hs-img-comp-wrapper">
                                        <img class="hs-img-comp hs-img-comp-b" src="assets/img/1618x1010/img2.jpg"
                                            alt="Image Description">
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-4">
                    ...
                    <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
                        ...
                        <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img1.jpg"
                                alt="Image Description" data-hs-theme-appearance="default">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img1-dark.jpg"
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
                        ...
                        <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img6.jpg"
                                alt="Image Description">
                        </div>
                    </a>
                    <!-- End Card -->
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
                        ...
                        <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img12.jpg"
                                alt="Image Description" data-hs-theme-appearance="default">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img12-dark.jpg"
                                alt="Image Description" data-hs-theme-appearance="dark">
                        </div>
                    </a>
                    <!-- End Card -->
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
                        ...
                        <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img11.jpg"
                                alt="Image Description" data-hs-theme-appearance="default">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img11-dark.jpg"
                                alt="Image Description" data-hs-theme-appearance="dark">
                        </div>
                    </a>
                    <!-- End Card -->
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
                        ...
                        <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img3.jpg"
                                alt="Image Description" data-hs-theme-appearance="default">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img3-dark.jpg"
                                alt="Image Description" data-hs-theme-appearance="dark">
                        </div>
                    </a>
                    <!-- End Card -->
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
                        ...
                        <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img2.jpg"
                                alt="Image Description" data-hs-theme-appearance="default">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img2-dark.jpg"
                                alt="Image Description" data-hs-theme-appearance="dark">
                        </div>
                    </a>
                    <!-- End Card -->
                ...
                <div class="col-md-6 mb-4 mb-md-0">
                    ...
                    <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
                        ...
                        <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img13.jpg"
                                alt="Image Description" data-hs-theme-appearance="default">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img13-dark.jpg"
                                alt="Image Description" data-hs-theme-appearance="dark">
                        </div>
                    </a>
                    <!-- End Card -->
                ...
                <div class="col-md-6">
                    ...
                    <a class="card card-lg card-transition h-100 bg-light border-0 shadow-none overflow-hidden"
                        ...
                        <div class="card-footer border-0 pt-0 mb-n4 me-n6">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img5.jpg"
                                alt="Image Description" data-hs-theme-appearance="default">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img5-dark.jpg"
                                alt="Image Description" data-hs-theme-appearance="dark">
                        </div>
                    </a>
                    <!-- End Card -->
        ...
        <div class="container-lg">
            <div class="bg-light content-space-2 rounded-3 px-5">
                <div class="w-md-70 text-center mx-md-auto">
                    <div class="mb-4">
                        <img class="img-fluid mx-auto" src="assets/svg/illustrations/oc-review.svg"
        ...
        <div class="content-space-b-2">
            ...
            <div class="sliding-img mb-5">
                ...
                <div class="sliding-img-frame-to-start"
                    style="background-image: url(assets/img/others/img1-dark.png);" data-hs-theme-appearance="dark">
                </div>
            </div>
            ...
            <div class="row align-items-md-center content-space-b-1 content-space-b-lg-2">
                <div class="col-md-6 order-md-2 mb-10 mb-md-0">
                    ...
                    <figure class="device-browser">
                        ...
                        <div class="device-browser-frame">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img7.jpg"
                                alt="Image Description" data-hs-theme-appearance="default">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img7-dark.jpg"
                                alt="Image Description" data-hs-theme-appearance="dark">
                        </div>
            ...
            <div class="row align-items-md-center content-space-1 content-space-b-lg-2">
                <div class="col-md-6 order-md-2 mb-10 mb-md-0">
                    ...
                    <figure class="device-browser">
                        ...
                        <div class="device-browser-frame">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img8.jpg"
                                alt="Image Description" data-hs-theme-appearance="default">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img8-dark.jpg"
                                alt="Image Description" data-hs-theme-appearance="dark">
                        </div>
            ...
            <div class="row align-items-md-center content-space-1 content-space-b-lg-2">
                <div class="col-md-6 order-md-2 mb-10 mb-md-0">
                    ...
                    <figure class="device-browser">
                        ...
                        <div class="device-browser-frame">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img9.jpg"
                                alt="Image Description" data-hs-theme-appearance="default">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img9-dark.jpg"
                                alt="Image Description" data-hs-theme-appearance="dark">
                        </div>
            ...
            <div class="row align-items-md-center content-space-t-1">
                <div class="col-md-6 order-md-2 mb-10 mb-md-0">
                    ...
                    <figure class="device-browser">
                        ...
                        <div class="device-browser-frame">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img10.jpg"
                                alt="Image Description" data-hs-theme-appearance="default">
                            <img class="img-fluid shadow-lg" src="assets/img/900x562/img10-dark.jpg"
                                alt="Image Description" data-hs-theme-appearance="dark">
                        </div>
            ...
            <div class="w-md-75 w-lg-50 mx-md-auto mb-5 mb-md-9">
                ...
                <div class="row justify-content-center">
                    <div class="col-auto col-sm-3 col-sm py-3">
                        <img class="avatar avatar-xl avatar-4x3" src="assets/svg/brands/bootstrap-gray.svg"
                            alt="Logo">
                    </div>
                    <!-- End Col -->

                    <div class="col-auto col-sm-3 col-sm py-3">
                        <img class="avatar avatar-xl avatar-4x3" src="assets/svg/brands/sass-gray.svg"
                            alt="Logo">
                    </div>
                    <!-- End Col -->

                    <div class="col-auto col-sm-3 col-sm py-3">
                        <img class="avatar avatar-xl avatar-4x3" src="assets/svg/brands/gulp-gray.svg"
                            alt="Logo">
                    </div>
                    <!-- End Col -->
    ...
    <!-- Go To -->
    <a class="js-go-to go-to position-fixed" href="javascript:void(0)" style="visibility: hidden;"
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:38:25 GMT -->
