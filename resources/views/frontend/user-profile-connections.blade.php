...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/user-profile-connections.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:30 GMT -->
                                ...
                                <div class="col mb-3 mb-lg-5">
                                    ...
                                    <div class="card h-100">
                                        ...
                                        <div class="card-body text-center">
                                            <!-- Avatar -->
                                            <div
                                                class="avatar avatar-xl avatar-soft-primary avatar-circle avatar-centered mb-3">
                                                ...
                                                <div class="col-auto py-1">
                                                    ...
                                                    <div class="form-check form-check-switch">
                                                        <input class="form-check-input" type="checkbox"
                                                            value="" id="connectionsCheckbox1" checked>
                                        ...
                                        <div class="card-footer">
                                            <div class="row justify-content-between align-items-center">
                                                ...
                                                <div class="col-auto py-1">
                                                    ...
                                                    <div class="form-check form-check-switch">
                                                        <input class="form-check-input" type="checkbox"
                                                            value="" id="connectionsCheckbox2" checked>
                                                        <label class="form-check-label btn btn-sm"
                                        ...
                                        <div class="card-pinned">
                                            <div class="card-pinned-top-end">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button"
                                                        class="btn btn-ghost-secondary btn-icon btn-sm rounded-circle"
                                                        id="connectionsDropdown3" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                                        <i class="bi-three-dots-vertical"></i>
                                                    </button>
                                ...
                                <div class="col mb-3 mb-lg-5">
                                    ...
                                    <div class="card h-100">
                                        <div class="card-pinned">
                                            <div class="card-pinned-top-end">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button"
                                                        class="btn btn-ghost-secondary btn-icon btn-sm rounded-circle"
                                                        id="connectionsDropdown4" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                                        <i class="bi-three-dots-vertical"></i>
                                                    </button>
                                        ...
                                        <div class="card-body text-center">
                                            <!-- Avatar -->
                                            <div
                                                class="avatar avatar-xl avatar-soft-dark avatar-circle avatar-centered mb-3">
                                        ...
                                        <div class="card-pinned">
                                            <div class="card-pinned-top-end">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button"
                                                        class="btn btn-ghost-secondary btn-icon btn-sm rounded-circle"
                                                        id="connectionsDropdown5" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                                        <i class="bi-three-dots-vertical"></i>
                                                    </button>
                                        ...
                                        <div class="card-footer">
                                            <div class="row justify-content-between align-items-center">
                                                ...
                                                <div class="col-auto py-1">
                                                    ...
                                                    <div class="form-check form-check-switch">
                                                        <input class="form-check-input" type="checkbox"
                                                            value="" id="connectionsCheckbox5" checked>
                                                        <label class="form-check-label btn btn-sm"
                                                            for="connectionsCheckbox5">
                                                            <span class="form-check-default">
                                                                <i class="bi-person-plus-fill"></i> Connect
                                                            </span>
                                                            <span class="form-check-active">
                                        ...
                                        <div class="card-pinned">
                                            <div class="card-pinned-top-end">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button"
                                                        class="btn btn-ghost-secondary btn-icon btn-sm rounded-circle"
                                                        id="connectionsDropdown6" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                                        <i class="bi-three-dots-vertical"></i>
                                                    </button>
                                        ...
                                        <div class="card-footer">
                                            <div class="row justify-content-between align-items-center">
                                                ...
                                                <div class="col-auto py-1">
                                                    ...
                                                    <div class="form-check form-check-switch">
                                                        <input class="form-check-input" type="checkbox"
                                                            value="" id="connectionsCheckbox6" checked>
                                                        <label class="form-check-label btn btn-sm"
                                                            for="connectionsCheckbox6">
                                                            <span class="form-check-default">
                                                                <i class="bi-person-plus-fill"></i> Connect
                                                            </span>
                                                            <span class="form-check-active">
                                        ...
                                        <div class="card-pinned">
                                            <div class="card-pinned-top-end">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button"
                                                        class="btn btn-ghost-secondary btn-icon btn-sm rounded-circle"
                                                        id="connectionsDropdown7" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                                        <i class="bi-three-dots-vertical"></i>
                                                    </button>
                                        ...
                                        <div class="card-footer">
                                            <div class="row justify-content-between align-items-center">
                                                ...
                                                <div class="col-auto py-1">
                                                    ...
                                                    <div class="form-check form-check-switch">
                                                        <input class="form-check-input" type="checkbox"
                                                            value="" id="connectionsCheckbox7">
                                                        <label class="form-check-label btn btn-sm"
                                                            for="connectionsCheckbox7">
                                                            <span class="form-check-default">
                                                                <i class="bi-person-plus-fill"></i> Connect
                                                            </span>
                                                            <span class="form-check-active">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row align-items-md-center">
                                                    ...
                                                    <div class="col-sm-auto">
                                                        ...
                                                        <div class="form-check form-check-switch">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="" id="connectionsListCheckbox1"
                                                                checked>
                                                            <label class="form-check-label btn btn-sm"
                                                                for="connectionsListCheckbox1">
                                                                <span class="form-check-default">
                                                                    <i class="bi-person-plus-fill"></i> Connect
                                                                </span>
                                                                <span class="form-check-active">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row align-items-md-center">
                                                    ...
                                                    <div class="col-sm-auto">
                                                        ...
                                                        <div class="form-check form-check-switch">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="" id="connectionsListCheckbox2"
                                                                checked>
                                                            <label class="form-check-label btn btn-sm"
                                                                for="connectionsListCheckbox2">
                                                                <span class="form-check-default">
                                                                    <i class="bi-person-plus-fill"></i> Connect
                                                                </span>
                                                                <span class="form-check-active">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row align-items-md-center">
                                                    ...
                                                    <div class="col-sm-auto">
                                                        ...
                                                        <div class="form-check form-check-switch">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="" id="connectionsListCheckbox3">
                                                            <label class="form-check-label btn btn-sm"
                                                                for="connectionsListCheckbox3">
                                                                <span class="form-check-default">
                                                                    <i class="bi-person-plus-fill"></i> Connect
                                                                </span>
                                                                <span class="form-check-active">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row align-items-md-center">
                                                    ...
                                                    <div class="col-sm-auto">
                                                        ...
                                                        <div class="form-check form-check-switch">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="" id="connectionsListCheckbox4">
                                                            <label class="form-check-label btn btn-sm"
                                                                for="connectionsListCheckbox4">
                                                                <span class="form-check-default">
                                                                    <i class="bi-person-plus-fill"></i> Connect
                                                                </span>
                                                                <span class="form-check-active">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row align-items-md-center">
                                                    ...
                                                    <div class="col-sm-auto">
                                                        ...
                                                        <div class="form-check form-check-switch">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="" id="connectionsListCheckbox5"
                                                                checked>
                                                            <label class="form-check-label btn btn-sm"
                                                                for="connectionsListCheckbox5">
                                                                <span class="form-check-default">
                                                                    <i class="bi-person-plus-fill"></i> Connect
                                                                </span>
                                                                <span class="form-check-active">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row align-items-md-center">
                                                    ...
                                                    <div class="col-sm-auto">
                                                        ...
                                                        <div class="form-check form-check-switch">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="" id="connectionsListCheckbox6"
                                                                checked>
                                                            <label class="form-check-label btn btn-sm"
                                                                for="connectionsListCheckbox6">
                                                                <span class="form-check-default">
                                                                    <i class="bi-person-plus-fill"></i> Connect
                                                                </span>
                                                                <span class="form-check-active">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row align-items-md-center">
                                                    ...
                                                    <div class="col-sm-auto">
                                                        ...
                                                        <div class="form-check form-check-switch">
                                                            <input class="form-check-input" type="checkbox"
                                                                value="" id="connectionsListCheckbox7">
                                                            <label class="form-check-label btn btn-sm"
                                                                for="connectionsListCheckbox7">
                                                                <span class="form-check-default">
                                                                    <i class="bi-person-plus-fill"></i> Connect
                                                                </span>
                                                                <span class="form-check-active">
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/user-profile-connections.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:31 GMT -->
