...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/apps-file-manager.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:38:28 GMT -->
...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
            ...
            <div class="navbar-vertical-footer-offset">
                ...
                <div class="navbar-vertical-content">
                    <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                        ...
                        <div class="nav-item">
                            <a class="nav-link active" href="apps-file-manager.html" data-placement="left">
    ...
    <main id="content" role="main" class="main overflow-hidden">
        ...
        <div class="content container-fluid">
                    ...
                    <div class="col-sm mb-2 mb-sm-0">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb breadcrumb-no-gutter">
                                ...
                                <li class="breadcrumb-item"><a class="breadcrumb-link"
                                        href="javascript:void(0)">Project</a></li>
                        ...
                        <div class="btn-group" role="group">
                            ...
                            <div class="btn-group">
                                <button type="button" class="btn btn-primary dropdown-toggle"
                                    id="uploadGroupDropdown" data-bs-toggle="dropdown"
            ...
            <h2 class="h4 mb-3">Pinned access <i class="bi-question-circle text-muted" data-bs-toggle="tooltip"
                    data-bs-placement="right" title="Pinned access to files you've been working on."></i></h2>
            ...
            <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 mb-5">
                <div class="col mb-3 mb-lg-5">
                    ...
                    <div class="card card-sm card-hover-shadow h-100 text-center">
                        ...
                        <div class="form-check form-check-switch card-pinned-top-start zi-2">
                            <input class="form-check-input" type="checkbox" value="" id="starredCheckbox1"
                                checked>
                            <label class="form-check-label btn-icon btn-xs rounded-circle" for="starredCheckbox1">
                                <span class="form-check-default" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Pin">
                                    <i class="bi-star"></i>
                                </span>
                                <span class="form-check-active" data-bs-toggle="tooltip" data-bs-placement="top"
                                    title="Pinned">
                        ...
                        <div class="dropdown card-pinned-top-end">
                            <button type="button"
                                ...
                                id="pinnedAccessDropdown1" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="bi-three-dots-vertical"></i>
                            </button>

                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="pinnedAccessDropdown1"
                ...
                <div class="col mb-3 mb-lg-5">
                    ...
                    <div class="card card-sm card-hover-shadow h-100 text-center">
                        <!-- Form Check -->
                        <div class="form-check form-check-switch card-pinned-top-start zi-2">
                            <input class="form-check-input" type="checkbox" value="" id="starredCheckbox2"
                                checked>
                        ...
                        <div class="dropdown card-pinned-top-end">
                            <button type="button"
                                class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                id="pinnedAccessDropdown2" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="bi-three-dots-vertical"></i>
                            </button>

                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="pinnedAccessDropdown2"
                                style="min-width: 13rem;">
                                <span class="dropdown-header">Settings</span>
                        ...
                        <div class="card-body">
                            <img class="avatar avatar-4x3" src="assets/svg/brands/google-sheets-icon.svg"
                                alt="Image Description">
                        </div>
                ...
                <div class="col mb-3 mb-lg-5">
                    ...
                    <div class="card card-sm card-hover-shadow h-100 text-center">
                        <!-- Form Check -->
                        <div class="form-check form-check-switch card-pinned-top-start zi-2">
                            <input class="form-check-input" type="checkbox" value="" id="starredCheckbox3"
                                checked>
                        ...
                        <div class="dropdown card-pinned-top-end">
                            <button type="button"
                                class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                id="pinnedAccessDropdown3" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="bi-three-dots-vertical"></i>
                            </button>

                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="pinnedAccessDropdown3"
                                style="min-width: 13rem;">
                                <span class="dropdown-header">Settings</span>
                        ...
                        <div class="card-body">
                            <img class="avatar avatar-4x3" src="assets/svg/components/placeholder-img-format.svg"
                                alt="Image Description">
                        </div>
                ...
                <div class="col mb-3 mb-lg-5">
                    ...
                    <div class="card card-sm card-hover-shadow h-100 text-center">
                        <!-- Form Check -->
                        <div class="form-check form-check-switch card-pinned-top-start zi-2">
                            <input class="form-check-input" type="checkbox" value="" id="starredCheckbox4"
                                checked>
                        ...
                        <div class="dropdown card-pinned-top-end">
                            <button type="button"
                                class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                id="pinnedAccessDropdown4" data-bs-toggle="dropdown" aria-expanded="false">
                                <i class="bi-three-dots-vertical"></i>
                            </button>

                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="pinnedAccessDropdown4"
                                style="min-width: 13rem;">
                                <span class="dropdown-header">Settings</span>
                        ...
                        <div class="card-body">
                            <img class="avatar avatar-4x3" src="assets/svg/brands/google-slides-icon.svg"
                                alt="Image Description">
                        </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="dropdown ms-auto">
                                    <button type="button"
                                        class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                        id="folderDropdown1" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="bi-three-dots-vertical"></i>
                                    </button>

                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="folderDropdown1"
                                        style="min-width: 13rem;">
                                        <span class="dropdown-header">Settings</span>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="dropdown ms-auto">
                                    <button type="button"
                                        class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                        id="folderDropdown2" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="bi-three-dots-vertical"></i>
                                    </button>

                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="folderDropdown2"
                                        style="min-width: 13rem;">
                                        <span class="dropdown-header">Settings</span>
                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="dropdown ms-auto">
                                    <button type="button"
                                        class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                        id="folderDropdown3" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="bi-three-dots-vertical"></i>
                                    </button>

                                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="folderDropdown3"
                                        style="min-width: 13rem;">
                                        <span class="dropdown-header">Settings</span>
                    ...
                    <ul class="nav nav-segment" id="connectionsTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="grid-tab" data-bs-toggle="tab" href="#grid"
                                role="tab" aria-controls="grid" aria-selected="true" title="Column view">
                                <i class="bi-grid"></i>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="list-tab" data-bs-toggle="tab" href="#list"
                                role="tab" aria-controls="list" aria-selected="false" title="List view">
                            ...
                            <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                <div class="card-header card-header-content-between border-0">
                                    ...
                                    <div class="dropdown">
                                        <button type="button"
                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                            id="filesGridDropdown1" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <i class="bi-three-dots-vertical"></i>
                                        </button>
                                ...
                                <div class="card-body">
                                    <img class="avatar avatar-4x3" src="assets/svg/brands/google-docs-icon.svg"
                                        alt="Image Description">
                                </div>
                            ...
                            <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                <div class="card-header card-header-content-between border-0">
                                    ...
                                    <div class="dropdown">
                                        <button type="button"
                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                            id="filesGridDropdown2" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <i class="bi-three-dots-vertical"></i>
                                        </button>

                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="filesGridDropdown2" style="min-width: 13rem;">
                                            <span class="dropdown-header">Settings</span>
                                ...
                                <div class="card-body">
                                    <img class="avatar avatar-4x3" src="assets/svg/brands/pdf-icon.svg"
                                        alt="Image Description">
                                </div>
                            ...
                            <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                <div class="card-header card-header-content-between border-0">
                                    ...
                                    <div class="dropdown">
                                        <button type="button"
                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                            id="filesGridDropdown3" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <i class="bi-three-dots-vertical"></i>
                                        </button>

                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="filesGridDropdown3" style="min-width: 13rem;">
                                            <span class="dropdown-header">Settings</span>
                            ...
                            <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                <div class="card-header card-header-content-between border-0">
                                    ...
                                    <div class="dropdown">
                                        <button type="button"
                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                            id="filesGridDropdown4" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <i class="bi-three-dots-vertical"></i>
                                        </button>

                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="filesGridDropdown4" style="min-width: 13rem;">
                                            <span class="dropdown-header">Settings</span>
                            ...
                            <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                <div class="card-header card-header-content-between border-0">
                                    ...
                                    <div class="dropdown">
                                        <button type="button"
                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                            id="filesGridDropdown5" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <i class="bi-three-dots-vertical"></i>
                                        </button>

                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="filesGridDropdown5" style="min-width: 13rem;">
                                            <span class="dropdown-header">Settings</span>
                            ...
                            <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                <div class="card-header card-header-content-between border-0">
                                    ...
                                    <div class="dropdown">
                                        <button type="button"
                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                            id="filesGridDropdown6" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <i class="bi-three-dots-vertical"></i>
                                        </button>

                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="filesGridDropdown6" style="min-width: 13rem;">
                                            <span class="dropdown-header">Settings</span>
                            ...
                            <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                <div class="card-header card-header-content-between border-0">
                                    ...
                                    <div class="dropdown">
                                        <button type="button"
                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                            id="filesGridDropdown7" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <i class="bi-three-dots-vertical"></i>
                                        </button>

                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="filesGridDropdown7" style="min-width: 13rem;">
                                            <span class="dropdown-header">Settings</span>
                            ...
                            <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                <div class="card-header card-header-content-between border-0">
                                    ...
                                    <div class="dropdown">
                                        <button type="button"
                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                            id="filesGridDropdown8" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <i class="bi-three-dots-vertical"></i>
                                        </button>

                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="filesGridDropdown8" style="min-width: 13rem;">
                                            <span class="dropdown-header">Settings</span>
                            ...
                            <div class="card card-sm card-hover-shadow card-header-borderless h-100 text-center">
                                <div class="card-header card-header-content-between border-0">
                                    ...
                                    <div class="dropdown">
                                        <button type="button"
                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                            id="filesGridDropdown9" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <i class="bi-three-dots-vertical"></i>
                                        </button>

                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="filesGridDropdown9" style="min-width: 13rem;">
                                            <span class="dropdown-header">Settings</span>
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <img class="avatar avatar-xs avatar-4x3"
                                        src="assets/svg/brands/google-docs-icon.svg" alt="Image Description">
                                </div>
                                <!-- End Col -->
                                ...
                                <div class="col-auto">
                                    ...
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm"
                                            id="filesListDropdown1" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="filesListDropdown1" style="min-width: 13rem;">
                                            <span class="dropdown-header">Settings</span>
                        ...
                        <li class="list-group-item">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <img class="avatar avatar-xs avatar-4x3" src="assets/svg/brands/pdf-icon.svg"
                                        alt="Image Description">
                                </div>
                                <!-- End Col -->
                        ...
                        <li class="list-group-item">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <img class="avatar avatar-xs avatar-4x3"
                                        src="assets/svg/brands/google-slides-icon.svg" alt="Image Description">
                                </div>
                                <!-- End Col -->
                                ...
                                <div class="col-auto">
                                    ...
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm"
                                            id="filesListDropdown3" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <span class="d-none d-sm-inline-block me-1">More</span>
                                            <i class="bi-chevron-down"></i>
                                        </button>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="filesListDropdown3" style="min-width: 13rem;">
                                            <span class="dropdown-header">Settings</span>
                        ...
                        <li class="list-group-item">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    ...
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm"
                                            id="filesListDropdown4" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <span class="d-none d-sm-inline-block me-1">More</span>
                                            <i class="bi-chevron-down"></i>
                                        </button>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="filesListDropdown4" style="min-width: 13rem;">
                                            <span class="dropdown-header">Settings</span>
                        ...
                        <li class="list-group-item">
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <img class="avatar avatar-xs avatar-4x3"
                                        src="assets/svg/brands/google-sheets-icon.svg" alt="Image Description">
                                </div>
                                <!-- End Col -->
                                ...
                                <div class="col-auto">
                                    ...
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm"
                                            id="filesListDropdown5" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <span class="d-none d-sm-inline-block me-1">More</span>
                                            <i class="bi-chevron-down"></i>
                                        </button>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="filesListDropdown5" style="min-width: 13rem;">
                                            <span class="dropdown-header">Settings</span>
                        ...
                        <li class="list-group-item">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    ...
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm"
                                            id="filesListDropdown6" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <span class="d-none d-sm-inline-block me-1">More</span>
                                            <i class="bi-chevron-down"></i>
                                        </button>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="filesListDropdown6" style="min-width: 13rem;">
                                            <span class="dropdown-header">Settings</span>
                        ...
                        <li class="list-group-item">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    ...
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm"
                                            id="filesListDropdown7" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <span class="d-none d-sm-inline-block me-1">More</span>
                                            <i class="bi-chevron-down"></i>
                                        </button>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="filesListDropdown7" style="min-width: 13rem;">
                                            <span class="dropdown-header">Settings</span>
                        ...
                        <li class="list-group-item">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    ...
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm"
                                            id="filesListDropdown8" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <span class="d-none d-sm-inline-block me-1">More</span>
                                            <i class="bi-chevron-down"></i>
                                        </button>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="filesListDropdown8" style="min-width: 13rem;">
                                            <span class="dropdown-header">Settings</span>
                        ...
                        <li class="list-group-item">
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    ...
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm"
                                            id="filesListDropdown9" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <span class="d-none d-sm-inline-block me-1">More</span>
                                            <i class="bi-chevron-down"></i>
                                        </button>
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end"
                                            aria-labelledby="filesListDropdown9" style="min-width: 13rem;">
                                            <span class="dropdown-header">Settings</span>
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/apps-file-manager.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:38:29 GMT -->
