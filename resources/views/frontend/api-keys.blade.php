...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/api-keys.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:38:09 GMT -->
                ...
                <div class="card-header card-header-content-sm-between">
                    <div class="mb-2 mb-sm-0">
                        ...
                        <p class="card-text fs-5">Keys you have generated to connect with third-party clients or
                            access the <a class="link" href="#">Front API.</a></p>
                    </div>
                    ...
                    <div class="d-grid d-sm-flex justify-content-sm-between align-items-sm-center gap-2">
                        ...
                        <div id="datatableCounterInfo" style="display: none;">
                            <div class="d-flex align-items-center">
                                ...
                                <a class="btn btn-outline-danger btn-sm" href="javascript:void(0)"><i
