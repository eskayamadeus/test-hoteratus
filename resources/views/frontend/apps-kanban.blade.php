...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/apps-kanban.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:38:25 GMT -->
                        ...
                        <div class="d-flex">
                            ...
                            <div class="avatar-group avatar-circle me-3">
                                ...
                                <a class="avatar avatar-soft-info" href="user-profile.html"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="#digitalmarketing">
                                ...
                                <a class="avatar avatar-soft-dark" href="user-profile.html"
                                    data-bs-toggle="tooltip" data-bs-placement="top" title="Antony Taylor">
                                    <span class="avatar-initials">A</span>
                                </a>
            ...
            <div class="tab-pane fade show active" id="grid" role="tabpanel" aria-labelledby="grid-tab">
                ...
                "defaultCreated": 0
                            ...
                            <div class="js-sortable-disabled d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a class="js-create-field btn btn-white btn-icon btn-xs" href="javascript:void(0)"
                                    data-bs-toggle="tooltip" data-bs-placement="left" title="Add project">
                                    <i class="bi-plus"></i>
                                </a>
                            </div>
                            <!-- End Title -->
                            ...
                            <div class="js-sortable">
                                <!-- Card -->
                                <div class="js-sortable-link sortablejs-custom sortablejs-custom-rotate sortablejs-custom-handle"
                                    data-href="#">
                                    <div class="card mb-3">
                                        <div class="card-body">
                                                ...
                                                <div class="ms-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end"
                                                            aria-labelledby="kanbanProjectsGridDropdown1">
                                                            <a class="dropdown-item" href="#">
                                                                <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                                project
                                                            </a>
                                                            <a class="dropdown-item" href="#">
                                                                <i class="bi-star dropdown-item-icon"></i> Add to
                                                                favorites
                                                            </a>
                                                            <a class="dropdown-item" href="#">
                                                            ...
                                                            <a class="dropdown-item text-danger" href="#">
                                                                <i
                                                                    class="bi-trash dropdown-item-icon text-danger"></i>
                                                                Remove
                                                            </a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="d-flex mb-5">
                                                ...
                                                <div class="ms-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        <button type="button"
                                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                            id="kanbanProjectsGridDropdown2"
                                                            data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i class="bi-three-dots-vertical"></i>
                                                        </button>

                                                        <div class="dropdown-menu dropdown-menu-end"
                                                            aria-labelledby="kanbanProjectsGridDropdown2">
                                                            <a class="dropdown-item" href="#">
                                                                <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                                project
                                                            </a>
                                            ...
                                            <div class="d-flex mb-5">
                                                ...
                                                <div class="ms-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        <button type="button"
                                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                            id="kanbanProjectsGridDropdown3"
                                                            data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i class="bi-three-dots-vertical"></i>
                                                        </button>

                                                        <div class="dropdown-menu dropdown-menu-end"
                                                            aria-labelledby="kanbanProjectsGridDropdown3">
                                                            <a class="dropdown-item" href="#">
                                                                <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                                project
                                                            </a>
                            ...
                            <!-- Card -->
                            <div class="d-grid">
                                <a class="js-sortable-disabled js-create-field btn btn-white btn-dashed-outline"
                            ...
                            <form id="createProjectGridTemplateToDo" style="display: none;">
                                <div class="js-sortable-link sortablejs-custom sortablejs-custom-rotate sortablejs-custom-handle"
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-body">
                                            <div class="mb-4">
                                                <textarea class="form-control" placeholder="What needs to be done?" data-name="body"
                                                    aria-label="What needs to be done?"></textarea>
                                            </div>

                                            <div class="d-flex justify-content-end gap-3">
                                                <a class="js-delete-field btn btn-white btn-sm"
                                            ...
                                            <div class="d-flex mb-5">
                                                ...
                                                <div class="ms-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        <button type="button"
                                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                            id="kanbanProjectsGridDropdown4"
                                                            data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i class="bi-three-dots-vertical"></i>
                                                        </button>

                                                        <div class="dropdown-menu dropdown-menu-end"
                                                            aria-labelledby="kanbanProjectsGridDropdown4">
                                                            <a class="dropdown-item" href="#">
                                                                <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                                project
                                                            </a>
                                ...
                                <div class="js-sortable-link sortablejs-custom sortablejs-custom-rotate sortablejs-custom-handle"
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-body">
                                            <div class="d-flex mb-5">
                                                <div class="me-2">
                                                    <h4 class="text-wrap">Update Slack integration to use the new bot
                                                        token</h4>
                                                ...
                                                <div class="ms-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        <button type="button"
                                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                            id="kanbanProjectsGridDropdown5"
                                                            data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i class="bi-three-dots-vertical"></i>
                                                        </button>

                                                        <div class="dropdown-menu dropdown-menu-end"
                                                            aria-labelledby="kanbanProjectsGridDropdown5">
                                                            <a class="dropdown-item" href="#">
                                                                <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                                project
                                                            </a>
                                            ...
                                            <div class="d-flex mb-5">
                                                ...
                                                <div class="ms-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        <button type="button"
                                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                            id="kanbanProjectsGridDropdown6"
                                                            data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i class="bi-three-dots-vertical"></i>
                                                        </button>

                                                        <div class="dropdown-menu dropdown-menu-end"
                                                            aria-labelledby="kanbanProjectsGridDropdown6">
                                                            <a class="dropdown-item" href="#">
                                                                <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                                project
                                                            </a>
                 ...
                 "defaultCreated": 0
                                            ...
                                            <div class="d-flex mb-5">
                                                ...
                                                <div class="ms-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        <button type="button"
                                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                            id="kanbanProjectsGridDropdown7"
                                                            data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i class="bi-three-dots-vertical"></i>
                                                        </button>

                                                        <div class="dropdown-menu dropdown-menu-end"
                                                            aria-labelledby="kanbanProjectsGridDropdown7">
                                                            <a class="dropdown-item" href="#">
                                                                <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                                project
                                                            </a>
                                ...
                                <div class="js-sortable-link sortablejs-custom sortablejs-custom-rotate sortablejs-custom-handle"
                                    ...
                                    <div class="card mb-3">
                                        <div class="card-body">
                                            <div class="d-flex mb-5">
                                                <div class="me-2">
                                                    <h4 class="text-wrap">Mobile: notifications for subscribe pages
                                                        and goals</h4>
                                                ...
                                                <div class="ms-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        <button type="button"
                                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                            id="kanbanProjectsGridDropdown8"
                                                            data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i class="bi-three-dots-vertical"></i>
                                                        </button>

                                                        <div class="dropdown-menu dropdown-menu-end"
                                                            aria-labelledby="kanbanProjectsGridDropdown8">
                                                            <a class="dropdown-item" href="#">
                                                                <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                                project
                                                            </a>
                                            ...
                                            <div class="d-flex mb-5">
                                                ...
                                                <div class="ms-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        <button type="button"
                                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                            id="kanbanProjectsGridDropdown9"
                                                            data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i class="bi-three-dots-vertical"></i>
                                                        </button>

                                                        <div class="dropdown-menu dropdown-menu-end"
                                                            aria-labelledby="kanbanProjectsGridDropdown9">
                                                            <a class="dropdown-item" href="#">
                                                                <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                                project
                                                            </a>
                                            ...
                                            <div class="d-flex mb-5">
                                                ...
                                                <div class="ms-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        <button type="button"
                                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                            id="kanbanProjectsGridDropdown10"
                                                            data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i class="bi-three-dots-vertical"></i>
                                                        </button>

                                                        <div class="dropdown-menu dropdown-menu-end"
                                                            aria-labelledby="kanbanProjectsGridDropdown10">
                                                            <a class="dropdown-item" href="#">
                                                                <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                                project
                                                            </a>
                        ...
                        <li class="col-12">
                            ...
                            <div class="js-sortable-disabled d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a class="btn btn-white btn-icon btn-xs" href="javascript:void(0)"
                                    data-bs-toggle="tooltip" data-bs-placement="left" title="Create group">
                                    <i class="bi-plus"></i>
                                </a>
                            </div>
                            <!-- End Title -->
                ...
                <div class="content container-fluid">
                  ...
                  "defaultCreated": 0
                            ...
                            <div class="js-sortable-disabled d-flex justify-content-between align-items-center mb-3">
                                ...
                                <a class="js-create-field btn btn-icon btn-sm btn-white" href="javascript:void(0)"
                                    data-bs-toggle="tooltip" data-bs-placement="left" title="Add project">
                                    <i class="bi-plus"></i>
                                </a>
                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button"
                                                        class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                        id="kanbanProjectsListDropdown1" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                                        <i class="bi-three-dots-vertical"></i>
                                                    </button>

                                                    <div class="dropdown-menu dropdown-menu-end"
                                                        aria-labelledby="kanbanProjectsListDropdown1">
                                                        <a class="dropdown-item" href="#">
                                                            <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                            project
                                                        </a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button"
                                                        class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                        id="kanbanProjectsListDropdown2" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                                        <i class="bi-three-dots-vertical"></i>
                                                    </button>

                                                    <div class="dropdown-menu dropdown-menu-end"
                                                        aria-labelledby="kanbanProjectsListDropdown2">
                                                        <a class="dropdown-item" href="#">
                                                            <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                            project
                                                        </a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button"
                                                        class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                        id="kanbanProjectsListDropdown3" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                                        <i class="bi-three-dots-vertical"></i>
                                                    </button>

                                                    <div class="dropdown-menu dropdown-menu-end"
                                                        aria-labelledby="kanbanProjectsListDropdown3">
                                                        <a class="dropdown-item" href="#">
                                                            <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                            project
                                                        </a>
                                ...
                                <div class="js-sortable-link sortablejs-custom-handle card mb-3" data-href="#">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-end gap-3">
                                            <a class="js-delete-field btn btn-white btn-sm"
                                                href="javascript:void(0)">Cancel</a>
                                            <a class="btn btn-primary btn-sm" href="javascript:void(0)">Create</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button"
                                                        class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                        id="kanbanProjectsListDropdown4" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                                        <i class="bi-three-dots-vertical"></i>
                                                    </button>

                                                    <div class="dropdown-menu dropdown-menu-end"
                                                        aria-labelledby="kanbanProjectsListDropdown4">
                                                        <a class="dropdown-item" href="#">
                                                            <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                            project
                                                        </a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button"
                                                        class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                        id="kanbanProjectsListDropdown5" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                                        <i class="bi-three-dots-vertical"></i>
                                                    </button>

                                                    <div class="dropdown-menu dropdown-menu-end"
                                                        aria-labelledby="kanbanProjectsListDropdown5">
                                                        <a class="dropdown-item" href="#">
                                                            <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                            project
                                                        </a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button"
                                                        class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                        id="kanbanProjectsListDropdown6" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                                        <i class="bi-three-dots-vertical"></i>
                                                    </button>

                                                    <div class="dropdown-menu dropdown-menu-end"
                                                        aria-labelledby="kanbanProjectsListDropdown6">
                                                        <a class="dropdown-item" href="#">
                                                            <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                            project
                                                        </a>
                            ...
                            <div class="js-sortable">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button"
                                                        class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                        id="kanbanProjectsListDropdown7" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                                        <i class="bi-three-dots-vertical"></i>
                                                    </button>

                                                    <div class="dropdown-menu dropdown-menu-end"
                                                        aria-labelledby="kanbanProjectsListDropdown7">
                                                        <a class="dropdown-item" href="#">
                                                            <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                            project
                                                        </a>
                                ...
                                <div class="js-sortable-link sortablejs-custom-handle card mb-3" data-href="#">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col">
                                                <h4 class="text-wrap">Mobile: notifications for subscribe pages and
                                                    goals</h4>
                                            </div>
                                            <!-- End Col -->
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button"
                                                        class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                        id="kanbanProjectsListDropdown8" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                                        <i class="bi-three-dots-vertical"></i>
                                                    </button>

                                                    <div class="dropdown-menu dropdown-menu-end"
                                                        aria-labelledby="kanbanProjectsListDropdown8">
                                                        <a class="dropdown-item" href="#">
                                                            <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                            project
                                                        </a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button"
                                                        class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                        id="kanbanProjectsListDropdown9" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                                        <i class="bi-three-dots-vertical"></i>
                                                    </button>

                                                    <div class="dropdown-menu dropdown-menu-end"
                                                        aria-labelledby="kanbanProjectsListDropdown9">
                                                        <a class="dropdown-item" href="#">
                                                            <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                            project
                                                        </a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <div class="dropdown">
                                                    <button type="button"
                                                        class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                        id="kanbanProjectsListDropdown10" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                                        <i class="bi-three-dots-vertical"></i>
                                                    </button>

                                                    <div class="dropdown-menu dropdown-menu-end"
                                                        aria-labelledby="kanbanProjectsListDropdown10">
                                                        <a class="dropdown-item" href="#">
                                                            <i class="bi-pencil dropdown-item-icon"></i> Rename
                                                            project
                                                        </a>
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/apps-kanban.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:38:26 GMT -->
