...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/project-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:38:06 GMT -->
                        ...
                        <div id="navbarVerticalMenuPagesMenu">
                            ...
                            <div class="nav-item">
                                ...
                                <div id="navbarVerticalMenuPagesProjectMenu" class="nav-collapse collapse show"
                                    ...
                                    <a class="nav-link active" href="project-settings.html">Settings</a>
                                </div>
                            </div>
                            <!-- End Collapse -->
                ...
                <div class="col-lg-9">
                    ...
                    <div class="card card-lg mb-3 mb-lg-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <label class="avatar avatar-xl avatar-circle avatar-uploader me-5"
                                        for="avatarUploader">
                                        <img id="avatarProjectSettingsImg" class="avatar-img"
                                            src="assets/svg/brands/guideline-icon.svg" alt="Image Description">
                            ...
                            <!-- Form -->
                            <div class="mb-4">
                                <label for="projectNameProjectSettingsLabel" class="form-label">Project name <i
                                        class="bi-question-circle text-body ms-1" data-bs-oggle="tooltip"
                                ...
                                <div class="input-group input-group-merge">
                                    ...
                                    <input type="text" class="form-control" name="projectName"
                                        id="projectNameProjectSettingsLabel" placeholder="Enter project name here"
                                        aria-label="Enter project name here" value="Cloud computing web service">
                                </div>
                            </div>
                            <!-- End Form -->
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="mb-4">
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" class="form-control" name="expectedValue"
                                                ...
                                                aria-label="Enter value here" value="100,000 USD">
                                        </div>
                                    </div>
                                    <!-- End Form -->
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="mb-4">
                                        <label for="milestoneNewProjectLabel" class="form-label">Milestone <a
                                                class="fs-6 ms-1" href="javascript:void(0)">Change
                                                probability</a></label>
                                ...
                                "hideSearch": true
                                                ...
                                                <option value="privacy1" selected
                            ...
                            <div class="d-grid gap-2">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value=""
                                        id="budgetNewProjectCheckbox" checked>
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/project-settings.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:38:07 GMT -->
