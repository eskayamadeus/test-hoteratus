...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/project-activity.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:38:05 GMT -->
            ...
            <div class="row justify-content-lg-center">
                <div class="col-lg-9">
                    ...
                    <div class="alert alert-soft-dark mb-5 mb-lg-7" role="alert">
                        <div class="d-flex align-items-center">
                            <div class="flex-shrink-0">
                                <img class="avatar avatar-xl" src="assets/svg/illustrations/oc-megaphone.svg"
                                    alt="Image Description" data-hs-theme-appearance="default">
                                <img class="avatar avatar-xl" src="assets/svg/illustrations-light/oc-megaphone.svg"
                                    alt="Image Description" data-hs-theme-appearance="dark">
                            </div>

                            <div class="flex-grow-1 ms-3">
                                <h3 class="alert-heading mb-1">Attention!</h3>
                                <p class="mb-0">Hi! This project is due for an update. The last update was published
                                    2 days ago.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <ul class="step">
                        ...
                        <li class="step-item">
                            <div class="step-content-wrapper">
                                ...
                                <div class="step-content">
                                    ...
                                    <p class="fs-5 mb-1">Uploaded weekly reports to the task <a
                        ...
                        <li class="step-item">
                            <div class="step-content-wrapper">
                                <div class="step-avatar">
                                    <img class="step-avatar-img" src="assets/img/160x160/img6.jpg"
                                        alt="Image Description">
                                </div>
                                    ...
                                    <ul class="list-group list-group-sm">
                                        ...
                                        <li class="list-group-item list-group-item-light">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 text-truncate ms-2">
                                                    <span
                                                        class="d-block text-dark text-truncate">Requirements.figma</span>
                                        ...
                                        <li class="list-group-item list-group-item-light">
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1 text-truncate ms-2">
                                                    <span
                                                        class="d-block text-dark text-truncate">Requirements.sketch</span>
                        ...
                        <li class="step-item">
                            <div class="step-content-wrapper">
                                ...
                                <div class="step-content">
                                    ...
                                    <p class="fs-5">Marked project status as <span
                                            class="badge bg-soft-primary text-primary rounded-pill"><span
                                                class="legend-indicator bg-primary"></span>"In progress"</span></p>
                                </div>
                            </div>
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/project-activity.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:38:06 GMT -->
