...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ecommerce-customers.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:53 GMT -->
...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
            ...
            <div class="page-header">
                <div class="row align-items-center mb-3">
                    <div class="col-md mb-2 mb-md-0">
                        <h1 class="page-header-title">Customers <span
                                class="badge bg-soft-dark text-dark ms-2">97,524</span></h1>

                        <div class="d-sm-flex mt-2">
                            <a class="d-inline-block text-body mb-2 mb-sm-0 me-3" href="javascript:void(0)"
                                data-bs-toggle="modal" data-bs-target="#importCustomersModal">
                                <i class="bi-upload me-1"></i> Import customers
                            </a>
                            <a class="d-inline-block text-body mb-2 mb-sm-0 me-3" href="javascript:void(0)"
                                data-bs-toggle="modal" data-bs-target="#exportCustomersModal">
                            ...
                            <div class="dropdown">
                                <a class="d-inline-block text-body mb-2 mb-sm-0 me-3" href="javascript:void(0)"
                                    id="moreOptionsDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                ...
                <div class="js-nav-scroller hs-nav-scroller-horizontal">
                    ...
                    <ul class="nav nav-tabs page-header-tabs">
                        ...
                        <li class="nav-item">
                            <a class="nav-link disabled" href="#" tabindex="-1"
                                aria-disabled="true">Returning</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link disabled" href="#" tabindex="-1"
                                aria-disabled="true">Abandoned checkouts</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link disabled" href="#" tabindex="-1"
                                aria-disabled="true">Email subscribers</a>
                        </li>
                    </ul>
                    <!-- End Nav -->
                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="d-grid gap-3">
                                            ...
                                            <label class="row form-check form-switch"
                                                for="toggleColumn_account_status">
                                                <span class="col-8 col-sm-9 ms-0">
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="ecommerce-customer-details.html">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <span class="h5 text-inherit">Ella Lauda <i
                                                    class="bi-patch-check-fill text-primary"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="Top endorsed"></i></span>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="ecommerce-customer-details.html">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <span class="h5 text-inherit">Rachel Doe <i
                                                    class="bi-patch-check-fill text-primary"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="Top endorsed"></i></span>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="ecommerce-customer-details.html">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <span class="h5 text-inherit">Clarice Boone <i
                                                    class="bi-patch-check-fill text-primary"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="Top endorsed"></i></span>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="ecommerce-customer-details.html">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <span class="h5 text-inherit">Mark Williams <i
                                                    class="bi-patch-check-fill text-primary"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="Top endorsed"></i></span>
                                        </div>
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="ecommerce-customer-details.html">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <span class="h5 text-inherit">Gary Bishop <i
                                                    class="bi-patch-check-fill text-primary"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="Top endorsed"></i></span>
                                        </div>
    ...
    <div class="modal fade" id="exportCustomersModal" tabindex="-1" aria-labelledby="exportCustomersModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <!-- Header -->
                ...
                <div class="modal-body">
                    <div class="mb-4">
                        ...
                        <div class="d-grid gap-2">
                            <!-- Form Check -->
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="exportCustomersRadio"
                                    id="exportCustomersRadio1" checked>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="exportCustomersRadio"
                                    id="exportCustomersRadio3" disabled>
                    ...
                    <!-- Form Check -->
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="exportCustomersAsRadio"
                            id="exportCustomersAsRadio1" checked>
    ...
    <div class="modal fade" id="importCustomersModal" tabindex="-1" aria-labelledby="importCustomersModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <!-- Header -->
                ...
                <div class="modal-body">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" value=""
                            id="overwriteCurrentCustomersCheckbox">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-sm-5">
                    ...
                    <div class="d-flex">
                        <div class="flex-shrink-0">
                            <img class="avatar avatar-xl avatar-4x3" src="assets/svg/illustrations/oc-chatting.svg"
                                alt="Image Description" data-hs-theme-appearance="default">
                        ...
                        <div class="flex-grow-1 ms-4">
                            ...
                            <p>The E-commerce is where you can view &amp; manage your customers and all their activity
                                at your business.</p>
                        </div>
                    </div>
                    <!-- End Media -->
                    ...
                    <div class="d-flex">
                        <div class="flex-shrink-0">
                            <img class="avatar avatar-xl avatar-4x3"
                                src="assets/svg/illustrations/oc-looking-for-answers.svg" alt="Image Description"
                                data-hs-theme-appearance="default">
                            <img class="avatar avatar-xl avatar-4x3"
                                src="assets/svg/illustrations-light/oc-looking-for-answers.svg"
                                alt="Image Description" data-hs-theme-appearance="dark">
                        </div>
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ecommerce-customers.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:54 GMT -->
