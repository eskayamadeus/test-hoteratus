...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/user-profile-projects.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:29 GMT -->
                        ...
                        <div id="navbarVerticalMenuPagesMenu">
                            ...
                            <div class="nav-item">
                                ...
                                <div id="navbarVerticalMenuPagesUserProfileMenu" class="nav-collapse collapse show"
                                    ...
                                    <a class="nav-link active" href="user-profile-projects.html">Projects</a>
                ...
                <div class="col-lg-10">
                    ...
                    <div class="js-nav-scroller hs-nav-scroller-horizontal mb-5">
                        ...
                        <ul class="nav nav-tabs align-items-center">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="user-profile-projects.html">Projects <span
                                    ...
                                    <div class="card card-hover-shadow text-center h-100">
                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center text-start mb-4">
                                                <div class="col">
                                                    <span class="badge bg-soft-secondary text-secondary p-2">To
                                                        do</span>
                                                </div>
                                                <!-- End Col -->
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end"
                                                            ...
                                                            <a class="dropdown-item" href="#">Rename project
                                                            </a>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <!-- Avatar Group -->
                                                <div
                                                    class="avatar-group avatar-group-sm avatar-circle card-avatar-group">
                                ...
                                <div class="col mb-3 mb-lg-5">
                                    ...
                                    <div class="card card-hover-shadow text-center h-100">
                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center text-start mb-4">
                                                <div class="col">
                                                    <span class="badge bg-soft-primary text-primary p-2">In
                                                        progress</span>
                                                </div>
                                                <!-- End Col -->
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        <button type="button"
                                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                            id="projectsGridDropdown1" data-bs-toggle="dropdown"
                                                            aria-expanded="false">
                                                            <i class="bi-three-dots-vertical"></i>
                                                        </button>
                                            ...
                                            <div class="d-flex justify-content-center mb-2">
                                                <!-- Avatar -->
                                                <img class="avatar avatar-lg" src="assets/svg/brands/spec-icon.svg"
                                                    alt="Image Description">
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <div
                                                    ...
                                                    <a class="avatar avatar-soft-info" href="#"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="Sara Iwens">
                                                    ...
                                                    <a class="avatar avatar-light avatar-circle" href="#"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                    ...
                                    <div class="card card-hover-shadow text-center h-100">
                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center text-start mb-4">
                                                <div class="col">
                                                    <span
                                                        class="badge bg-soft-success text-success p-2">Completed</span>
                                                </div>
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        <button type="button"
                                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                            id="projectsGridDropdown6" data-bs-toggle="dropdown"
                                                            aria-expanded="false">
                                                            <i class="bi-three-dots-vertical"></i>
                                                        </button>
                                            ...
                                            <div class="row align-items-center text-start mb-4">
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        <button type="button"
                                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                            id="projectsGridDropdown2" data-bs-toggle="dropdown"
                                                            aria-expanded="false">
                                                            <i class="bi-three-dots-vertical"></i>
                                                        </button>
                                            ...
                                            <div class="row align-items-center text-start mb-4">
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        <button type="button"
                                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                            id="projectsGridDropdown4" data-bs-toggle="dropdown"
                                                            aria-expanded="false">
                                                            <i class="bi-three-dots-vertical"></i>
                                                        </button>
                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center text-start mb-4">
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        <button type="button"
                                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                            id="projectsGridDropdown7" data-bs-toggle="dropdown"
                                                            aria-expanded="false">
                                                            <i class="bi-three-dots-vertical"></i>
                                                        </button>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <div
                                                    ...
                                                    <a class="avatar avatar-soft-primary" href="#"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="Daniel Cs.">
                                ...
                                <div class="col mb-3 mb-lg-5">
                                    ...
                                    <div class="card card-hover-shadow text-center h-100">
                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center text-start mb-4">
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        <button type="button"
                                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                            id="projectsGridDropdown3" data-bs-toggle="dropdown"
                                                            aria-expanded="false">
                                                            <i class="bi-three-dots-vertical"></i>
                                                        </button>
                                            ...
                                            <div class="d-flex justify-content-center mb-2">
                                                <!-- Avatar -->
                                                <img class="avatar avatar-lg" src="assets/svg/brands/figma-icon.svg"
                                                    alt="Image Description">
                                            </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center text-start mb-4">
                                                ...
                                                <div class="col-auto">
                                                    ...
                                                    <div class="dropdown">
                                                        <button type="button"
                                                            class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                            id="projectsGridDropdown5" data-bs-toggle="dropdown"
                                                            aria-expanded="false">
                                                            <i class="bi-three-dots-vertical"></i>
                                                        </button>
                                            ...
                                            <div class="d-flex justify-content-center">
                                                ...
                                                <div
                                                    ...
                                                    <a class="avatar avatar-soft-danger" href="#"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="Teresa Eyker">
                                                    ...
                                                    <a class="avatar avatar-soft-warning" href="#"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="Olivier L.">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row align-items-sm-center">
                                                    <div class="col">
                                                        <span
                                                            class="badge bg-soft-secondary text-secondary p-2 mb-2">To
                                                            do</span>
                                                    ...
                                                    <div
                                                        class="col-md-3 d-none d-md-flex justify-content-md-end ms-n3">
                                                        <!-- Avatar Group -->
                                                        <div
                                                            class="avatar-group avatar-group-sm avatar-circle card-avatar-group">
                                                            <a class="avatar" href="#"
                                                    ...
                                                    <div class="col-auto">
                                                        ...
                                                        <div class="dropdown">
                                                            <button type="button"
                                                                class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                                id="projectsListDropdown1" data-bs-toggle="dropdown"
                                                                aria-expanded="false">
                                                                <i class="bi-three-dots-vertical"></i>
                                                            </button>
                                    ...
                                    <div class="card card-body">
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row align-items-sm-center">
                                                    <div class="col">
                                                        <span class="badge bg-soft-primary text-primary p-2 mb-2">In
                                                            progress</span>
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <a class="avatar avatar-light avatar-circle"
                                                    ...
                                                    <div class="col-auto">
                                                        ...
                                                        <div class="dropdown">
                                                            <button type="button"
                                                                class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                                id="projectsListDropdown2" data-bs-toggle="dropdown"
                                                                aria-expanded="false">
                                                                <i class="bi-three-dots-vertical"></i>
                                                            </button>
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row align-items-sm-center">
                                                    <div class="col">
                                                        <span
                                                            class="badge bg-soft-success text-success p-2 mb-2">Completed</span>
                                                    ...
                                                    <div class="col-auto">
                                                        ...
                                                        <div class="dropdown">
                                                            <button type="button"
                                                                class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                                id="projectsListDropdown3" data-bs-toggle="dropdown"
                                                                aria-expanded="false">
                                                                <i class="bi-three-dots-vertical"></i>
                                                            </button>
                                                ...
                                                <div class="row align-items-sm-center">
                                                    ...
                                                    <div class="col-auto">
                                                        ...
                                                        <div class="dropdown">
                                                            <button type="button"
                                                                class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                                id="projectsListDropdown4" data-bs-toggle="dropdown"
                                                                aria-expanded="false">
                                                                <i class="bi-three-dots-vertical"></i>
                                                            </button>
                                                ...
                                                <div class="row align-items-sm-center">
                                                    ...
                                                    <div class="col-auto">
                                                        ...
                                                        <div class="dropdown">
                                                            <button type="button"
                                                                class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                                id="projectsListDropdown5" data-bs-toggle="dropdown"
                                                                aria-expanded="false">
                                                                <i class="bi-three-dots-vertical"></i>
                                                            </button>
                                                ...
                                                <div class="row align-items-sm-center">
                                                    ...
                                                    <div class="col-auto">
                                                        ...
                                                        <div class="dropdown">
                                                            <button type="button"
                                                                class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                                id="projectsListDropdown6" data-bs-toggle="dropdown"
                                                                aria-expanded="false">
                                                                <i class="bi-three-dots-vertical"></i>
                                                            </button>
                                                ...
                                                <div class="row align-items-sm-center">
                                                    ...
                                                    <div class="col-auto">
                                                        ...
                                                        <div class="dropdown">
                                                            <button type="button"
                                                                class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                                id="projectsListDropdown7" data-bs-toggle="dropdown"
                                                                aria-expanded="false">
                                                                <i class="bi-three-dots-vertical"></i>
                                                            </button>
                                                ...
                                                <div class="row align-items-sm-center">
                                                    ...
                                                    <div class="col-auto">
                                                        ...
                                                        <div class="dropdown">
                                                            <button type="button"
                                                                class="btn btn-ghost-secondary btn-icon btn-sm card-dropdown-btn rounded-circle"
                                                                id="projectsListDropdown8" data-bs-toggle="dropdown"
                                                                aria-expanded="false">
                                                                <i class="bi-three-dots-vertical"></i>
                                                            </button>
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/user-profile-projects.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:30 GMT -->
