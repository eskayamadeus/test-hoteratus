...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/users-leaderboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:24 GMT -->
                ...
                <div class="navbar-vertical-content">
                    <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                        ...
                        <div id="navbarVerticalMenuPagesMenu">
                            <!-- Collapse -->
                            <div class="nav-item">
                                <a class="nav-link dropdown-toggle active" href="#navbarVerticalMenuPagesUsersMenu"
                ...
                <div class="row align-items-end">
                    ...
                    <div class="col-sm-auto">
                        ...
                        <ul class="nav nav-segment" id="leaderboardTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" id="all-time-tab" data-bs-toggle="tab"
                                    href="#all-time" role="tab">
                                    All time
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="weekly-tab" data-bs-toggle="tab" href="#weekly"
                                    role="tab">
                                    Weekly
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="monthly-tab" data-bs-toggle="tab" href="#monthly"
                                    role="tab">
                                    Monthly
                                </a>
                            </li>
