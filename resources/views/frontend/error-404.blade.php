...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/error-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:38:08 GMT -->
                ...
                <div class="navbar-vertical-content">
                    <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                        ...
                        <div id="navbarVerticalMenuPagesMenu">
                            ...
                            <!-- Collapse -->
                            <div class="nav-item">
                                <a class="nav-link dropdown-toggle active collapsed" href="#" role="button"
                                    data-bs-toggle="collapse" data-bs-target="#navbarVerticalMenuAuthentication"
                                    aria-expanded="true" aria-controls="navbarVerticalMenuAuthentication">
                                    <i class="bi-shield-lock nav-icon"></i>
                                    <span class="nav-link-title">Authentication</span>
                                </a>

                                <div id="navbarVerticalMenuAuthentication" class="nav-collapse collapse show"
                                    data-bs-parent="#navbarVerticalMenu">
            ...
            <div class="row justify-content-center align-items-sm-center py-sm-10">
                <div class="col-9 col-sm-6 col-lg-4">
                    <div class="text-center text-sm-end me-sm-4 mb-5 mb-sm-0">
                        <img class="img-fluid" src="assets/svg/illustrations/oc-thinking.svg"
                            alt="Image Description" data-hs-theme-appearance="default">
                        <img class="img-fluid" src="assets/svg/illustrations-light/oc-thinking.svg"
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/error-404.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:38:09 GMT -->
