...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ecommerce-orders.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:51 GMT -->
                                    ...
                                    <div id="navbarVerticalMenuPagesMenuEcommerce">
                                        ...
                                        <div class="nav-item">
                                            ...
                                            <div id="navbarVerticalMenuPagesEcommerceOrdersMenu"
                                                ...
                                                data-bs-parent="#navbarVerticalMenuPagesMenuEcommerce">
                                                <a class="nav-link active" href="ecommerce-orders.html">Orders</a>
                ...
                <div class="row align-items-center mb-3">
                    <div class="col-sm">
                        <h1 class="page-header-title">Orders <span
                                class="badge bg-soft-dark text-dark ms-2">106,905</span></h1>
                        ...
                        <div class="d-flex mt-2">
                            ...
                            <!-- Dropdown -->
                            <div class="dropdowm">
                                <a class="text-body" href="javascript:void(0)" id="moreOptionsDropdown"
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <tbody>
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-end mt-1"
                                                ...
                                                <span class="dropdown-header">Options</span>
                                                <a class="js-export-copy dropdown-item" href="javascript:void(0)">
                                                    <img class="avatar avatar-xss avatar-4x3 me-2"
                                                        src="assets/svg/illustrations/copy-icon.svg"
                                                        alt="Image Description">
                                                    Copy
                                                </a>
                                                <a class="js-export-print dropdown-item" href="javascript:void(0)">
                                                    <img class="avatar avatar-xss avatar-4x3 me-2"
                                                ...
                                                <div class="dropdown-divider"></div>
                                                <span class="dropdown-header">Download options</span>
                                                <a class="js-export-excel dropdown-item" href="javascript:void(0)">
                                                    <img class="avatar avatar-xss avatar-4x3 me-2"
                                                        src="assets/svg/brands/excel-icon.svg"
                                                        alt="Image Description">
                                                    Excel
                                                </a>
                                                <a class="js-export-csv dropdown-item" href="javascript:void(0)">
                                                    <img class="avatar avatar-xss avatar-4x3 me-2"
                                                        src="assets/svg/components/placeholder-csv-format.svg"
                                                        alt="Image Description">
                                                    .CSV
                                                </a>
                                                <a class="js-export-pdf dropdown-item" href="javascript:void(0)">
                                                    <img class="avatar avatar-xss avatar-4x3 me-2"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="text-body" href="ecommerce-customer-details.html">Mathew
                                        Gustaffson</a>
                                </td>
                                <td>
                                    <span class="badge bg-soft-success text-success">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <img class="avatar avatar-xss avatar-4x3 me-2"
                                            src="assets/svg/brands/paypal-icon.svg" alt="Image Description">
                            ...
                            <tr>
                                ...
                                <td><a class="text-danger" href="ecommerce-customer-details.html">Jase Marley</a>
                                </td>
                                <td>
                                    <span class="badge bg-soft-warning text-warning">
                                        <span class="legend-indicator bg-warning"></span>Pending
                            ...
                            <tr>
                                ...
                                <td><a class="text-danger" href="ecommerce-customer-details.html">Kamilia
                                        Williams</a></td>
                                <td>
                                    <span class="badge bg-soft-warning text-warning">
                                        <span class="legend-indicator bg-warning"></span>Pending
                            ...
                            <tr>
                                ...
                                <td>
                                    <a class="text-body" href="ecommerce-customer-details.html">Anna
                                        Alexsandrova</a>
                                </td>
                                <td>
                                    <span class="badge bg-soft-success text-success">
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ecommerce-orders.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:52 GMT -->
