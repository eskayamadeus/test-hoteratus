...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/account-billing.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:35 GMT -->
...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
                ...
                <div class="navbar-vertical-content">
                    <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                        ...
                        <div id="navbarVerticalMenuPagesMenu">
                            ...
                            <!-- Collapse -->
                            <div class="nav-item">
                                <a class="nav-link dropdown-toggle active" href="#navbarVerticalMenuPagesAccountMenu"
                                    role="button" data-bs-toggle="collapse"
                                    data-bs-target="#navbarVerticalMenuPagesAccountMenu" aria-expanded="true"
                                    aria-controls="navbarVerticalMenuPagesAccountMenu">
                                    <i class="bi-person-badge nav-icon"></i>
                                    <span class="nav-link-title">Account</span>
                                </a>

                                <div id="navbarVerticalMenuPagesAccountMenu" class="nav-collapse collapse show"
                                    data-bs-parent="#navbarVerticalMenuPagesMenu">
                ...
                <div class="col-lg-9">
                    <div class="d-grid gap-3 gap-lg-5">
                                    ...
                                    <div class="col-md-auto">
                                        <div class="d-grid d-sm-flex gap-3">
                                            ...
                                            <button type="button" class="btn btn-primary w-100 w-sm-auto"
                                                ...
                                                data-bs-target="#accountUpdatePlanModal">Update plan</button>
                                        </div>
                                    </div>
                                    <!-- End Col -->
                                </div>
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-6 mb-5 mb-sm-7">
                                        <!-- Radio Check -->
                                        <div class="form-check form-check-inline w-100 h-100">
                                            <input type="radio" id="billingRadio2" name="billingRadio"
                                    ...
                                    <div class="col-sm-6 mb-5 mb-sm-7">
                                        <!-- Card -->
                                        <a class="card card-dashed card-centered" href="javascript:void(0)"
                                            data-bs-toggle="modal" data-bs-target="#accountAddAddressModal">
                                            <div class="card-body card-dashed-body py-8">
                                                ...
                                                <img class="avatar avatar-lg avatar-4x3 mb-2"
                                                    src="assets/svg/illustrations-light/oc-address.svg"
                                ...
                                <p class="mb-0">Your text location determines the taxes that are applied to your
                                    bill.</p>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="mb-4">
                                    <p>Cards will be charged either at the end of the month or whenever your balance
                                        exceeds the usage threshold. All major credit / debit cards accepted.</p>
                                </div>
                                ...
                                <ul class="list-group mb-5">
                                    ...
                                    <li class="list-group-item">
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img class="avatar avatar-sm" src="assets/svg/brands/mastercard.svg"
                                                    alt="Image Description">
                                            </div>
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row">
                                                    <div class="col-sm mb-3 mb-sm-0">
                                                        <span class="d-block text-dark">MasterCard
                                                            &bull;&bull;&bull;&bull; 4242</span>
                                                        <small class="d-block text-muted">Checking - Expires
                                                            12/22</small>
                                                    </div>
                                                    <!-- End Col -->
                                    ...
                                    <li class="list-group-item">
                                        <div class="mb-2">
                                            <h5>Maria Williams <span class="text-danger small ms-1">Expired</span>
                                            </h5>
                                        </div>
                                        ...
                                        <div class="d-flex">
                                            <div class="flex-shrink-0">
                                                <img class="avatar avatar-sm" src="assets/svg/brands/visa.svg"
                                                    alt="Image Description">
                                            </div>
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <div class="row">
                                                    <div class="col-sm mb-3 mb-sm-0">
                                                        <span class="d-block text-dark">Visa &bull;&bull;&bull;&bull;
                                                            9016</span>
                                                        <small class="d-block text-muted">Debit - Expires
                                                            04/20</small>
                                                    </div>
                                                    <!-- End Col -->
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <!-- Card -->
                                        <a class="card card-dashed card-centered" href="javascript:void(0)"
                                            data-bs-toggle="modal" data-bs-target="#accountAddCardModal">
                                            <div class="card-body card-dashed-body py-8">
                                                <img class="avatar avatar-lg avatar-4x3 mb-2"
                                                    src="assets/svg/illustrations/oc-add-card.svg"
                                                    alt="Image Description" data-hs-theme-appearance="default">
                                                <img class="avatar avatar-lg avatar-4x3 mb-2"
                                                    src="assets/svg/illustrations-light/oc-add-card.svg"
                                                    alt="Image Description" data-hs-theme-appearance="dark">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-white btn-sm" href="javascript:void(0)"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#accountInvoiceReceiptModal"><i
                                                        class="bi-eye-fill me-1"></i> Quick view</a>
                                            </td>
                                        </tr>

                                        <tr>
                                            <td><a href="#">#2333234</a></td>
                                            <td><span class="badge bg-soft-success text-success">Successful</span>
                                            </td>
                                            <td>$264</td>
                                            <td>22/04/2019</td>
                                            <td><a class="btn btn-white btn-sm" href="#"><i
                                                        class="bi-file-earmark-arrow-down-fill me-1"></i> PDF</a></td>
                                            <td><a class="btn btn-white btn-sm" href="javascript:void(0)"
                                                    data-bs-toggle="modal"
                                                    data-bs-target="#accountInvoiceReceiptModal"><i
                                                        class="bi-eye-fill me-1"></i> Quick view</a></td>
                                        </tr>
    ...
    <!-- Update Plan Modal -->
    <div class="modal fade" id="accountUpdatePlanModal" tabindex="-1"
        aria-labelledby="accountUpdatePlanModalLabel" role="dialog" aria-hidden="true">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" class="js-input-mask form-control" name="expirationDate"
                                        id="editCardEexpirationDateLabel" placeholder="xx/xxxx"
                                        aria-label="xx/xxxx" value="12/2022"
                                        data-hs-mask-options='{
                          "mask": "00/0000"
                        }'>
                                </div>
                    ...
                    <form>
                      ...
                      "mask": "0000 0000 0000 0000"
                        ...
                        <div class="form-check mb-4">
                            ...
                            <label class="form-check-label" for="makePrimaryCheckbox1">Make this primary
                                card</label>
                        </div>
                        <!-- End Custom Checkbox -->
    ...
    <!-- Add Address Modal -->
    <div class="modal fade" id="accountAddAddressModal" tabindex="-1"
        aria-labelledby="accountAddAddressModalLabel" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <!-- Header -->
                <div class="modal-header">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="d-flex align-items-center">
                                <img class="avatar avatar-xss me-2" src="assets/svg/brands/mastercard.svg"
                                    alt="Image Description">
                    ...
                    <p class="modal-footer-text">If you have any questions, please contact us at <a class="link"
                            ...
                            class="link text-nowrap" href="#">+1 898 34-5492</a></p>
                </div>
                <!-- End Body -->
            </div>
        </div>
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/account-billing.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:38 GMT -->
