...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/dashboard-default-dark-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:39:45 GMT -->
<head>
      ...
      <div class="page-header">
        <div class="row align-items-center">
          ...
          <div class="col-sm-auto">
            <a class="btn btn-primary" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#inviteUserModal">
            ...
            <div class="card-header card-header-content-sm-between">
              ...
              <ul class="nav nav-segment nav-fill" id="expensesTab" role="tablist">
                <li class="nav-item" data-bs-toggle="chart-bar" data-datasets="thisWeek" data-trigger="click" data-action="toggle">
                  <a class="nav-link active" href="javascript:void(0)" data-bs-toggle="tab">This week</a>
                </li>
          ...
          <div class="mb-4">
            <div class="input-group mb-2 mb-sm-0">
              ...
              <div class="input-group-append input-group-append-last-sm-down-none">
                ...
                <a class="btn btn-primary d-none d-sm-inline-block" href="javascript:void(0)">Invite</a>
              </div>
            </div>
        ...
        <div class="modal-footer">
          <div class="row align-items-center flex-grow-1 mx-n2">
            ...
            <div class="col-sm-3 text-sm-end">
              <a class="js-clipboard btn btn-white btn-sm text-nowrap" href="javascript:void(0)" data-bs-toggle="tooltip" data-bs-placement="top" title="Copy to clipboard!" data-hs-clipboard-options='{
                  "type": "tooltip",
                  "successText": "Copied!",
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/dashboard-default-dark-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:39:46 GMT -->
</html>