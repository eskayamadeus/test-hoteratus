...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/dashboard-default-collapsible-layout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:39:46 GMT -->
                ...
                <div class="collapse navbar-collapse" id="navbarContainerNavDropdown">
                    <ul class="navbar-nav">
                        ...
                        <li class="hs-has-sub-menu nav-item">
                            <a id="dashboardsMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle active"
                                href="#" role="button"><i class="bi-house-door dropdown-item-icon"></i>
                                Dashboards</a>
                        ...
                        <li class="hs-has-sub-menu nav-item">
                            ...
                            <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless"
                                ...
                                <div class="hs-has-sub-menu nav-item">
                                    <a id="usersMegaMenu" class="hs-mega-menu-invoker dropdown-item dropdown-toggle "
                        ...
                        <li class="hs-has-sub-menu nav-item">
                            <a id="appsMegaMenu" class="hs-mega-menu-invoker nav-link dropdown-toggle "
                                href="#" role="button"><i class="bi-app-indicator dropdown-item-icon"></i>
                                Apps</a>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush list-group-no-gutters">
                                ...
                                <li class="list-group-item"><span class="small text-muted">Or you can <a
                                            class="link" href="#">sync data to Front Dashboard</a> to ensure
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/dashboard-default-collapsible-layout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:39:47 GMT -->
