...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/dashboard-default-double-line.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:39:46 GMT -->
                                            ...
                                            <div class="card-header card-header-content-between">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu-borderless"
                                                        ...
                                                        <a class="dropdown-item" href="#">
                                                            <i class="bi-check2-all dropdown-item-icon"></i> Mark all
                                                            as read
                                                        </a>
                                                        <a class="dropdown-item" href="#">
                                                            ...
                                                            <li class="list-group-item form-check-select">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col ms-n2">
                                                                        ...
                                                                        <p class="text-body fs-5">changed an issue from
                                                                            "In Progress" to <span
                                                ...
                                                <a class="dropdown-item" href="#">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1 text-truncate ms-3">
                                                            ...
                                                            <p class="card-text text-body">Email collaboration software
                                                            </p>
                                                        </div>
                                                    </div>
                                                </a>
                                                ...
                                                <a class="dropdown-item" href="#">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1 text-truncate ms-3">
                                                            ...
                                                            <p class="card-text text-body">Work involved in developing
                                                                a website</p>
                                                        </div>
                                                    </div>
                                                </a>
                                                ...
                                                <a class="dropdown-item" href="#">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1 text-truncate ms-3">
                                                            ...
                                                            <p class="card-text text-body">Customer service and support
                                                            </p>
                                                        </div>
                                                    </div>
                                                </a>
                                                ...
                                                <a class="dropdown-item" href="#">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="flex-grow-1 text-truncate ms-3">
                                                            ...
                                                            <p class="card-text text-body">Check out more HS products
                                                            </p>
                                                        </div>
                                                    </div>
                                                </a>
