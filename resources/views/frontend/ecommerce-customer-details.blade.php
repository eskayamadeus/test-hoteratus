...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ecommerce-customer-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:54 GMT -->
                    ...
                    <div class="col-sm-auto">
                        <div class="d-flex gap-2">
                            <button type="button" class="btn btn-ghost-secondary btn-icon btn-sm rounded-circle"
                                data-bs-toggle="tooltip" data-bs-placement="right" title="Previous customer">
                                <i class="bi-arrow-left"></i>
                            </button>
                            <button type="button" class="btn btn-ghost-secondary btn-icon btn-sm rounded-circle"
                                data-bs-toggle="tooltip" data-bs-placement="right" title="Next customer">
                                ...
                                <div class="flex-grow-1 mx-3">
                                    <div class="d-flex mb-1">
                                        ...
                                        <div class="dropdown" data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="Edit">
                                            <button type="button"
                                                class="btn btn-white btn-icon btn-xs rounded-circle"
                                                id="editDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                                                <i class="bi-pencil-fill"></i>
                                            </button>

                                            <div class="dropdown-menu dropdown-card mt-1"
                                                aria-labelledby="editDropdown" style="min-width: 20rem;">
                                                <!-- Card -->
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="row gx-3">
                                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                                <label for="firstNameLabel" class="form-label">First
                                                                    name</label>
                                                                <input type="text" class="form-control"
                                                                    name="firstName" id="firstNameLabel"
                                                            ...
                                                            <div class="col-sm-6">
                                                                <label for="lastNameLabel" class="form-label">Last
                                                                    name</label>
                                                                <input type="text" class="form-control"
                                                                    name="lastName" id="lastNameLabel"
                                                        ...
                                                        <div class="d-flex justify-content-end gap-2 mt-3">
                                                            <button type="button"
                                                                class="btn btn-white btn-sm">Cancel</button>
                                                            <button type="button"
                        ...
                        <div class="card-header card-header-content-sm-between">
                            ...
                            <div class="js-nav-scroller hs-nav-scroller-horizontal">
                                ...
                                <ul class="nav nav-segment nav-fill">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link disabled" href="#" tabindex="-1"
                                            aria-disabled="true">Unfulfilled</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link disabled" href="#" tabindex="-1"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-white btn-sm" href="javascript:void(0)"
                                                data-bs-toggle="modal" data-bs-target="#accountInvoiceReceiptModal">
                              ...
                              "toolbar": [
                                ...
                                <li class="step-item">
                                    <div class="step-content-wrapper">
                                        ...
                                        <div class="step-content">
                                            <h5 class="mb-0">You added the email anne@gmail.com to this customer.
                                            </h5>
                ...
                <div class="col-lg-4">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-group list-group-flush list-group-no-gutters">
                                ...
                                <li class="list-group-item">
                                    ...
                                    <!-- Leaflet (Map) -->
                                    <div id="map" class="leaflet-custom rounded mt-1 mb-3"
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <div class="card-header card-header-content-between">
                            ...
                            <a class="link" href="javascript:void(0)">Edit status</a>
                        </div>
                        <!-- End Header -->
                    ...
                    <div class="card mb-3 mb-lg-5">
                        ...
                        <!-- Body -->
                        <div class="card-body">
                            <p>Website activity shows you how many times a contact has visited your site and viewed your
                                pages.</p>
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ecommerce-customer-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:55 GMT -->
