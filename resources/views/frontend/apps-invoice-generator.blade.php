...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/apps-invoice-generator.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:38:26 GMT -->
            ...
            <div class="navbar-vertical-footer-offset">
                ...
                <div class="navbar-vertical-content">
                    <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                        ...
                        <div class="nav-item">
                            <a class="nav-link active" href="apps-invoice-generator.html" data-placement="left">
                ...
                <div class="col-lg-9 mb-5 mb-lg-0">
                    ...
                    <div class="card card-lg">
                              ...
                              "allowTypes": [".png", ".jpeg", ".jpg"]
                                ...
                                <div class="col-md-5 text-md-end">
                                    ...
                                    <div class="d-grid d-md-flex justify-content-md-end mb-2 mb-md-4">
                                        <input type="text" class="form-control w-auto" placeholder=""
                                            aria-label="" value="0982131">
                                    </div>
                                    <!-- End Form -->

                                    <textarea class="form-control" placeholder="Who is this invoice from?" id="invoiceAddressFromLabel"
                                        aria-label="Who is this invoice from?" rows="3"></textarea>
                                </div>
                                <!-- End Col -->
                            </div>
                            <!-- End Row -->
                            ...
                            <div class="row mb-3">
                                <div class="col-md-5">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control" placeholder="Who is this invoice from?" id="invoiceAddressToLabel"
                                            aria-label="Who is this invoice from?" rows="3"></textarea>
                                    </div>
                                    <!-- End Form -->
                                </div>
                              ...
                              "wrap": true
                                        ...
                                        <dl class="row align-items-sm-center">
                                            ...
                                            <dd class="col-md-auto mb-0">
                                                <!-- Flatpickr -->
                                                <div id="invoiceDueDateFlatpickr"
                                                    class="js-flatpickr flatpickr-custom"
                                                    data-hs-flatpickr-options='{
                      ...
                      "defaultCreated": 0
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <input type="text" class="form-control mb-3" placeholder="Item name"
                                    ...
                                    <div class="col col-md-2">
                                        <input type="number" class="form-control-plaintext mb-3"
                                            ...
                                            <div class="tom-select-custom tom-select-custom-end">
                                                <div id="taxSelect" class="input-group">
                                                    <input type="number" class="form-control" placeholder="0.00"
                                                        aria-label="0.00" style="min-width: 5rem;">
                                                    <!-- Select -->
                            ...
                            <div class="mb-4">
                                ...
                                <textarea class="form-control" placeholder="Who is this invoice to?" id="invoiceNotesLabel"
                                    aria-label="Who is this invoice to?" rows="3"></textarea>
                            </div>
                            <!-- End Form -->
                   ...
                   "stickyOffsetTop": 20
                            ...
                            <div class="row gx-3">
                                <div class="col-sm mb-2 mb-sm-0">
                                    <div class="d-grid">
                                        <a class="btn btn-white" href="javascript:void(0)">Preview</a>
                                    </div>
                                </div>
                                <!-- End Col -->
                                ...
                                <div class="col-sm">
                                    <div class="d-grid">
                                        <a class="btn btn-white" href="javascript:void(0)">Save</a>
                                    </div>
                                </div>
                                <!-- End Col -->
                            </div>
                            ...
                            "hideSearch": true
                                        ...
                                        <option value="currency3"
                                            ...
                                            Euro (Euro Member Countries)</option>
                                    </select>
                                </div>
                                <!-- End Select -->
                            </div>
                            ...
                            <div class="d-grid gap-3">
                                ...
                                <label class="row form-check form-switch" for="invoicePaymentTermsSwitch">
                                    ...
                                    <span class="col-4 col-sm-3 text-end">
                                        <input type="checkbox" class="form-check-input"
                                            id="invoicePaymentTermsSwitch" checked>
                                    </span>
                                </label>
                                <!-- End Form Switch -->
                                ...
                                <label class="row form-check form-switch" for="invoiceClientNotesSwitch">
                                    ...
                                    <span class="col-4 col-sm-3 text-end">
                                        <input type="checkbox" class="form-check-input"
                                            id="invoiceClientNotesSwitch" checked>
                                    </span>
                                </label>
                                <!-- End Form Switch -->
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/apps-invoice-generator.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:38:28 GMT -->
