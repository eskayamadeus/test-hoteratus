...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/dashboard-default-sidebar-detached.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:39:47 GMT -->
...
<body class="bg-light">
    ...
    <!-- ========== HEADER ========== -->
    <header id="header"
        class="navbar navbar-expand-lg navbar-sidebar-detached navbar-fixed-lg navbar-light bg-light">
        <div class="container">
                                    ...
                                    <div class="card-body-height">
                                        ...
                                        <a class="dropdown-item" href="index.html">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-grow-1 text-truncate ms-2">
                                                    <span>Amanda Harvey <i class="bi-patch-check-fill text-primary"
                                        ...
                                        <div class="card-header card-header-content-between">
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless"
                                                    ...
                                                    <a class="dropdown-item" href="#">
                                                        <i class="bi-check2-all dropdown-item-icon"></i> Mark all as
                                                        read
                                                    </a>
                                                    <a class="dropdown-item" href="#">
                                                        ...
                                                        <li class="list-group-item form-check-select">
                                                            <div class="row">
                                                                ...
                                                                <div class="col ms-n2">
                                                                    ...
                                                                    <p class="text-body fs-5">Start using forms to
                                                                        capture the information of prospects visiting
                                                        ...
                                                        <li class="list-group-item form-check-select">
                                                            <div class="row">
                                                                ...
                                                                <div class="col ms-n2">
                                                                    ...
                                                                    <p class="text-body fs-5">left Slack group HS
                                                                        projects</p>
                                                                </div>
                                                                <!-- End Col -->
                                                        ...
                                                        <li class="list-group-item form-check-select">
                                                            <div class="row">
                                                                ...
                                                                <div class="col ms-n2">
                                                                    ...
                                                                    <p class="text-body fs-5">Accepted your connection
                                                                    </p>
                                                                </div>
                                                                <!-- End Col -->
                                            ...
                                            <a class="dropdown-item" href="#">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 text-truncate ms-3">
                                                        ...
                                                        <p class="card-text text-body">Security and control across
                                                            Cloud</p>
                                                    </div>
                                                </div>
                                            </a>
        ...
        <div class="content container pt-2 pt-lg-0">
            ...
            <div class="navbar-expand-lg navbar-light">
                ...
                <button class="navbar-toggler w-100 mb-3" type="button" data-bs-toggle="collapse"
                    data-bs-target="#navbarVerticalNavMenu" aria-controls="navbarVerticalNavMenu"
                ...
                <aside id="navbarVerticalNavMenu"
                    class="js-navbar-vertical-aside navbar navbar-vertical navbar-vertical-fixed navbar-vertical-detached navbar-vertical-detached-no-gutters navbar-collapse collapse bg-transparent">
                                ...
                                <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                                    ...
                                    <div class="nav-item">
                                        <a class="nav-link dropdown-toggle active"
                                            href="#navbarVerticalMenuDashboards" role="button"
                                    ...
                                    <div id="navbarVerticalMenuPagesMenu">
                                        ...
                                        <div class="nav-item">
                                            <a class="nav-link dropdown-toggle "
                                                href="#navbarVerticalMenuPagesUsersMenu" role="button"
                                        ...
                                        <div class="nav-item">
                                            ...
                                            <div id="navbarVerticalMenuPagesUserProfileMenu"
                                                ...
                                                <a class="nav-link " href="user-profile-my-profile.html">My
                                                    Profile</a>
                                            </div>
                                        </div>
                                        <!-- End Collapse -->
                                        ...
                                        <div class="nav-item">
                                            ...
                                            <div id="navbarVerticalMenuPagesEcommerceMenu"
                                                class="nav-collapse collapse "
                                                data-bs-parent="#navbarVerticalMenuPagesMenu">
                                                ...
                                                <a class="nav-link " href="ecommerce-manage-reviews.html">Manage
                                                    Reviews</a>
                                        ...
                                        <div class="nav-item">
                                            <a class="nav-link dropdown-toggle "
                                                href="#navbarVerticalMenuPagesProjectsMenu" role="button"
                                                data-bs-toggle="collapse"
                                            ...
                                            <div id="navbarVerticalMenuPagesProjectsMenu"
                                                class="nav-collapse collapse "
                                                data-bs-parent="#navbarVerticalMenuPagesMenu">
                                        ...
                                        <div class="nav-item">
                                            <a class="nav-link dropdown-toggle "
                                                href="#navbarVerticalMenuPagesProjectMenu" role="button"
                                                data-bs-toggle="collapse"
                                            ...
                                            <div id="navbarVerticalMenuPagesProjectMenu"
                                                class="nav-collapse collapse "
                                                data-bs-parent="#navbarVerticalMenuPagesMenu">
                                    ...
                                    <div class="nav-item">
                                        <a class="nav-link " href="documentation/typography.html"
                                            data-placement="left">
                                ...
                                <ul class="navbar-vertical-footer-list">
                                    ...
                                    <li class="navbar-vertical-footer-list-item">
                                        ...
                                        <div class="dropdown dropup">
                                            <button type="button"
                                                class="btn btn-ghost-secondary btn-icon rounded-circle"
                                                id="otherLinksDropdown" data-bs-toggle="dropdown"
                                                aria-expanded="false" data-bs-dropdown-animation>
                                            ...
                                            <div class="dropdown-menu navbar-dropdown-menu-borderless"
                                                ...
                                                <a class="dropdown-item" href="#">
                                                    ...
                                                    <span class="text-truncate"
                                                        title="Resources &amp; tutorials">Resources &amp;
                                                        tutorials</span>
                                                </a>
                                                <a class="dropdown-item" href="#">
                                                ...
                                                <a class="dropdown-item" href="#">
                                                    ...
                                                    <span class="text-truncate" title="Connect other apps">Connect
                                                        other apps</span>
                                                </a>
                                                <a class="dropdown-item" href="#">
                                                    <i class="bi-gift dropdown-item-icon"></i>
                                                    <span class="text-truncate" title="What's new?">What's
                                                        new?</span>
                                                </a>
                                                <div class="dropdown-divider"></div>
                                    ...
                                    <li class="navbar-vertical-footer-list-item">
                                        ...
                                        <div class="dropdown dropup">
                                            <button type="button"
                                                class="btn btn-ghost-secondary btn-icon rounded-circle"
                                                id="selectLanguageDropdown" data-bs-toggle="dropdown"
                                                aria-expanded="false" data-bs-dropdown-animation>
            ...
            <div class="sidebar-detached-content">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-header card-header-content-between">
                                ...
                                <div class="dropdown">
                                    <button type="button"
                                        ...
                                        id="reportsOverviewDropdown2" data-bs-toggle="dropdown"
                                        aria-expanded="false">
                                        <i class="bi-three-dots-vertical"></i>
                                    </button>
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-group list-group-flush list-group-no-gutters">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto">
                                                        <a class="btn btn-primary btn-sm" href="#"
                                                            ...
                                                            Launch <span
                                                                class="d-none d-sm-inline-block">importer</span>
                                    ...
                                    <li class="list-group-item"><span class="small text-muted">Or you can <a
                                                class="link" href="#">sync data to Front Dashboard</a> to
                                            ensure your data is always up-to-date.</span></li>
                                </ul>
                            </div>
                            <!-- End Body -->
                        </div>
                                ...
                                <ul class="nav nav-segment nav-fill" id="expensesTab" role="tablist">
                                    <li class="nav-item" data-bs-toggle="chart-bar" data-datasets="thisWeek"
                                        ...
                                        <a class="nav-link active" href="javascript:void(0)"
                                            data-bs-toggle="tab">This week</a>
                                    </li>
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <div class="tom-select-custom">
                                                    <select
                                                        ...
                                                        data-target-column-index="2" autocomplete="off"
                                        ...
                                        <div class="row align-items-center gx-0">
                                            ...
                                            <div class="col-auto">
                                                ...
                                                <div class="tom-select-custom">
                                                    <select
                                                        class="js-select js-datatable-filter form-select form-select-sm form-select-borderless"
                                                        data-target-column-index="5" autocomplete="off"
                                                        data-hs-tom-select-options='{
                                    "searchInDropdown": false,
                                    "hideSearch": true,
                                    "dropdownWidth": "10rem"
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-header card-header-content-between">
                                ...
                                <div class="dropdown">
                                    <button type="button"
                                        class="btn btn-ghost-secondary btn-icon btn-sm rounded-circle"
                                        id="reportsOverviewDropdown1" data-bs-toggle="dropdown"
                                        aria-expanded="false">
                                        <i class="bi-three-dots-vertical"></i>
                                    </button>
                            ...
                            <div class="card-body">
                                ...
                                <div class="progress rounded-pill mb-2">
                                    <div class="progress-bar" role="progressbar" style="width: 25%"
                                        ...
                                        data-bs-toggle="tooltip" data-bs-placement="top" title="Gross value">
                                    </div>
                ...
                <div class="row justify-content-between align-items-center mt-3">
                    <div class="col">
                        <p class="fs-6 mb-0">&copy; Front. <span class="d-none d-sm-inline-block">2021
                                Htmlstream.</span></p>
                    </div>
                    <div class="col-auto">
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/dashboard-default-sidebar-detached.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:39:48 GMT -->
