...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ecommerce-add-customers.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:55 GMT -->
                                        ...
                                        <div class="nav-item">
                                            ...
                                            <div id="navbarVerticalMenuPagesEcommerceCustomersMenu"
                                                ...
                                                <a class="nav-link " href="ecommerce-customer-details.html">Customer
                                                    Details</a>
                                                <a class="nav-link active" href="ecommerce-add-customers.html">Add
                                                    Customers</a>
                                            </div>
                                        </div>
                                        <!-- End Collapse -->
                      ...
                      "defaultCreated": 0
                           ...
                           "mask": "+0(000)000-00-00"
                            ...
                            <div class="form-check mb-4">
                                ...
                                <label class="form-check-label" for="marketingEmailsCheckbox">I want to receive
                                    promotions, announcements, and marketing emails.</label>
                            </div>
                            <!-- End Form Check -->
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="firstNameAddress"
                                            id="firstNameAddressLabel" placeholder="Clarice" aria-label="Clarice">
                                    </div>
                                    <!-- End Form -->
                                </div>
                                <!-- End Col -->
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control" name="lastNameAddress"
                                            id="lastNameAddressLabel" placeholder="Boone" aria-label="Boone">
                                    </div>
                                    <!-- End Form -->
                                </div>
                                <!-- End Col -->
                            ...
                            "placeholder": "Select country"
                                ...
                                <div class="mb-3">
                                    <input type="text" class="form-control" name="AddressCity"
                                        id="AddressCityLabel" placeholder="City" aria-label="City">
                                </div>

                                <input type="text" class="form-control" name="AddressState"
                                    id="AddressStateLabel" placeholder="State" aria-label="State">
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="mb-4">
                                <label for="AddressLine2Label" class="form-label">Address line 2 <span
                                        class="form-label-secondary">(Optional)</span></label>
                            ...
                            <!-- Form -->
                            <div class="mb-4">
                                <label for="addresszipCodeLabel" class="form-label">Zip code <i
                                        class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                        data-bs-placement="top"
                                        title="You can find your code in a postal address."></i></label>

                                <input type="text" class="js-input-mask form-control" name="addresszipCode"
                                    id="addresszipCodeLabel" placeholder="Your zip code"
                         ...
                         "mask": "AA0 0AA"
                            ...
                            <div class="form-check mb-4">
                                ...
                                <label class="form-check-label" for="billingAddressCheckbox">Same as shipping
                                    address</label>
                            </div>
                            <!-- End Form Check -->
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="firstNameBillingAddressLabel" class="form-label">First
                                            name</label>
                                        <input type="text" class="form-control" name="firstNameBillingAddress"
                                            id="firstNameBillingAddressLabel" placeholder="Clarice"
                                            aria-label="Clarice">
                                    </div>
                                    <!-- End Form -->
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <!-- Form -->
                                    <div class="mb-4">
                                        <label for="lastNameBillingAddressLabel" class="form-label">Last
                                            name</label>
                                        <input type="text" class="form-control" name="lastNameBillingAddress"
                                            id="lastNameBillingAddressLabel" placeholder="Boone"
                                            aria-label="Boone">
                                    </div>
                                    <!-- End Form -->
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="tom-select-custom mb-4">
                                    <select class="js-select form-select" id="billingLocationLabel"
                                        autocomplete="off"
                                        data-hs-tom-select-options='{
                            "placeholder": "Select country"
                          }'>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" name="billingAddressLine1"
                                    id="billingAddressLine1Label" placeholder="Your address"
                            ...
                            <!-- Form -->
                            <div class="mb-4">
                                <label for="billingAddressLine2Label" class="form-label">Address line 2 <span
                                        class="form-label-secondary">(Optional)</span></label>
                                <input type="text" class="form-control" name="billingAddressLine2"
                                    id="billingAddressLine2Label" placeholder="Your address"
                                    aria-label="Your address">
                            </div>
                            <!-- End Form -->
                            ...
                            <!-- Form -->
                            <div class="mb-4">
                                <label for="billingZipCodeLabel" class="form-label">Zip code <i
                                        class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                        data-bs-placement="top"
                                        title="You can find your code in a postal address."></i></label>

                                <input type="text" class="js-input-mask form-control" name="billingZipCode"
                                    id="billingZipCodeLabel" placeholder="Your zip code"
                                    aria-label="Your zip code"
                                    data-hs-mask-options='{
                         "mask": "AA0 0AA"
                       }'>
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ecommerce-add-customers.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:57 GMT -->
