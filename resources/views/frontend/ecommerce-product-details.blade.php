...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ecommerce-product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:47 GMT -->
            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-sm mb-2 mb-sm-0">
                        ...
                        <div class="mt-2">
                            <a class="text-body me-3" href="javascript:void(0)">
                    ...
                    <div class="col-sm-auto">
                        <div class="d-flex gap-2">
                            <button type="button"
                                class="btn btn-ghost-secondary btn-icon btn-sm rounded-circle me-1"
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control" name="productName"
                                    id="productNameLabel" placeholder="Shirt, t-shirts, etc."
                                    aria-label="Shirt, t-shirts, etc." value="Tiro track jacket">
                            </div>
                            <!-- End Form -->
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="weightName"
                                    ...
                                    "dropdownWidth": "6rem"
                                        ...
                                        <small class="form-text">Used to calculate shipping rates at checkout and
                                            label prices during fulfillment.</small>
                                    </div>
                                    <!-- End Form -->
                                </div>
                                <!-- End Col -->
                      ...
                      "modules": {
                        "toolbar": [
                          ["bold", "italic", "underline", "strike", "link", "image", "blockquote", "code", {"list": "bullet"}]
                                    ...
                                    <p>Train hard. Stay dry. This soccer jacket is made of soft, sweat-wicking fabric
                                        that keeps you moving on the practice field. Stretch panels at the elbows and
                                        sides give you a full range of motion as you work.</p>
                                    <p><br></p>
                            ...
                            <div id="fancyboxGallery" class="js-fancybox row justify-content-sm-center gx-3">
                                <div class="col-6 col-sm-4 col-md-3 mb-3 mb-lg-5">
                                    ...
                                    <div class="card card-sm">
                                        <img class="card-img-top" src="assets/img/400x400/img7.jpg"
                                            alt="Image Description">

                                        <div class="card-body">
                                            <div class="row col-divider text-center">
                                                <div class="col">
                                                    <a class="text-body" href="assets/img/725x1080/img1.jpg"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="View" data-fslightbox="gallery">
                                                        <i class="bi-eye"></i>
                                                    </a>
                                                </div>
                                                <!-- End Col -->
                                ...
                                <div class="col-6 col-sm-4 col-md-3 mb-3 mb-lg-5">
                                    <!-- Card -->
                                    <div class="card card-sm">
                                        <img class="card-img-top" src="assets/img/400x400/img8.jpg"
                                            alt="Image Description">

                                        <div class="card-body">
                                            <div class="row col-divider text-center">
                                                <div class="col">
                                                    <a class="text-body" href="assets/img/1920x1080/img1.jpg"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="View" data-fslightbox="gallery">
                                                        <i class="bi-eye"></i>
                                                    </a>
                                ...
                                <div class="col-6 col-sm-4 col-md-3 mb-3 mb-lg-5">
                                    <!-- Card -->
                                    <div class="card card-sm">
                                        <img class="card-img-top" src="assets/img/400x400/img9.jpg"
                                            alt="Image Description">

                                        <div class="card-body">
                                            <div class="row col-divider text-center">
                                                <div class="col">
                                                    <a class="text-body" href="assets/img/1920x1080/img2.jpg"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="View" data-fslightbox="gallery">
                                                        <i class="bi-eye"></i>
                                                    </a>
                                ...
                                <div class="col-6 col-sm-4 col-md-3 mb-3 mb-lg-5">
                                    ...
                                    <div class="card card-sm">
                                        ...
                                        <div class="card-body">
                                            <div class="row col-divider text-center">
                                                <div class="col">
                                                    <a class="text-body" href="assets/img/1920x1080/img3.jpg"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="View" data-fslightbox="gallery">
                                                        <i class="bi-eye"></i>
                                                    </a>
                ...
                "limit": 100
                        ...
                        <div class="card-header card-header-content-sm-between">
                            ...
                            <div class="d-sm-flex align-items-center gap-2">
                                ...
                                <a class="js-create-field btn btn-ghost-secondary btn-sm" href="javascript:void(0)">
                       ...
                       "isShowPaging": false
                                ...
                                <tbody id="addVariantsContainer">
                                    <tr>
                                        ...
                                        <th>
                                            <img class="avatar" src="assets/img/400x400/img7.jpg"
                                                alt="Image Description">
                                        </th>
                                        ...
                                        <th class="table-column-ps-0">
                                            ...
                                            <div class="quantity-counter">
                                                <div class="js-quantity-counter-input row align-items-center">
                                                    ...
                                                    <div class="col-auto">
                                                        <a class="js-minus btn btn-white btn-xs btn-icon rounded-circle"
                                                        ...
                                                        <a class="js-plus btn btn-white btn-xs btn-icon rounded-circle"
                                                            href="javascript:void(0)">
                                    ...
                                    <tr>
                                        <td class="table-column-pe-0">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label"
                                                    for="productVariationsCheck2"></label>
                                            </div>
                                        </td>
                                        <th>
                                            <img class="avatar" src="assets/img/400x400/img7.jpg"
                                    ...
                                    <tr>
                                        <td class="table-column-pe-0">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label"
                                                    for="productVariationsCheck3"></label>
                                            </div>
                                        </td>
                                        <th>
                                            <img class="avatar" src="assets/img/400x400/img7.jpg"
                                    ...
                                    <tr>
                                        <td class="table-column-pe-0">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label"
                                                    for="productVariationsCheck4"></label>
                                            </div>
                                        </td>
                                        <th>
                                            <img class="avatar" src="assets/img/400x400/img7.jpg"
                                    ...
                                    <tr>
                                        <td class="table-column-pe-0">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label"
                                                    for="productVariationsCheck5"></label>
                                            </div>
                                        </td>
                                        <th>
                                            <img class="avatar" src="assets/img/400x400/img7.jpg"
                                    ...
                                    <tr>
                                        <td class="table-column-pe-0">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label"
                                                    for="productVariationsCheck6"></label>
                                            </div>
                                        </td>
                                        <th>
                                            <img class="avatar" src="assets/img/400x400/img7.jpg"
                                    ...
                                    <tr>
                                        <td class="table-column-pe-0">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label"
                                                    for="productVariationsCheck7"></label>
                                            </div>
                                        </td>
                                        <th>
                                            <img class="avatar" src="assets/img/400x400/img7.jpg"
                                    ...
                                    <tr>
                                        <td class="table-column-pe-0">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label"
                                                    for="productVariationsCheck8"></label>
                                            </div>
                                        </td>
                                        <th>
                                            <img class="avatar" src="assets/img/400x400/img7.jpg"
                                    ...
                                    <tr>
                                        <td class="table-column-pe-0">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label"
                                                    for="productVariationsCheck9"></label>
                                            </div>
                                        </td>
                                        <th>
                                            <img class="avatar" src="assets/img/400x400/img7.jpg"
                                    ...
                                    <tr>
                                        <td class="table-column-pe-0">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label"
                                                    for="productVariationsCheck10"></label>
                                            </div>
                                        </td>
                                        <th>
                                            <img class="avatar" src="assets/img/400x400/img7.jpg"
                                    ...
                                    <tr>
                                        <td class="table-column-pe-0">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label"
                                                    for="productVariationsCheck11"></label>
                                            </div>
                                        </td>
                                        <th>
                                            <img class="avatar" src="assets/img/400x400/img7.jpg"
                                    ...
                                    <tr>
                                        <td class="table-column-pe-0">
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label"
                                                    for="productVariationsCheck12"></label>
                                            </div>
                                        </td>
                                        <th>
                                            <img class="avatar" src="assets/img/400x400/img7.jpg"
                        ...
                        <div class="card-footer">
                            <a class="js-create-field btn btn-sm btn-ghost-secondary" href="javascript:void(0)">
                                <i class="bi-plus"></i> Add variant
                            </a>
                        </div>
                        <!-- End Footer -->
                ...
                <div class="col-lg-4">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" name="priceName"
                                        id="priceNameLabel" placeholder="0.00" aria-label="0.00" value="45.00">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <input type="text" class="form-control" id="tagsLabel"
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ecommerce-product-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:50 GMT -->
