...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/projects.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:59 GMT -->
                ...
                <div class="navbar-vertical-content">
                    <div id="navbarVerticalMenu" class="nav nav-pills nav-vertical card-navbar-nav">
                        ...
                        <div id="navbarVerticalMenuPagesMenu">
                            ...
                            <!-- Collapse -->
                            <div class="nav-item">
                                <a class="nav-link dropdown-toggle active" href="#navbarVerticalMenuPagesProjectsMenu"
                                    role="button" data-bs-toggle="collapse"
                                    data-bs-target="#navbarVerticalMenuPagesProjectsMenu" aria-expanded="true"
                                    aria-controls="navbarVerticalMenuPagesProjectsMenu">
                                    <i class="bi-stickies nav-icon"></i>
                                    <span class="nav-link-title">Projects</span>
                                </a>

                                <div id="navbarVerticalMenuPagesProjectsMenu" class="nav-collapse collapse show"
                                    data-bs-parent="#navbarVerticalMenuPagesMenu">
                                    <a class="nav-link active" href="projects.html">Overview</a>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                      ...
                                      "placeholder": "Select member"
                                            ...
                                            <div class="d-grid">
                                                <a class="btn btn-primary" href="javascript:void(0)">Apply</a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="project.html">
                                        <img class="avatar" src="assets/svg/brands/guideline-icon.svg"
                                            alt="Image Description">
                                        <div class="ms-3">
                                            <span class="d-block h5 text-inherit mb-0">Cloud computing web
                                                service</span>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        120 <a class="badge bg-soft-dark text-dark ms-1" href="javascript:void(0)"
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="tasks completed today">+2</a>
                                    </div>
                                </td>
                                <td>
                                    <!-- Avatar Group -->
                                    <div class="avatar-group avatar-group-xs avatar-circle">
                                        ...
                                        <a class="avatar avatar-soft-info" href="user-profile.html"
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="Sara Iwens">
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="project.html">
                                        <img class="avatar" src="assets/svg/brands/capsule-icon.svg"
                                            alt="Image Description">
                                        <div class="ms-3">
                                            <span class="d-block h5 text-inherit mb-0">Build stronger customer
                                                relationships</span>
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="project.html">
                                        <img class="avatar" src="assets/svg/brands/mailchimp-icon.svg"
                                            alt="Image Description">
                                        <div class="ms-3">
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="project.html">
                                        ...
                                        <div class="ms-3">
                                            <span class="d-block h5 text-inherit mb-0">Extend Spotify mobile app
                                                features</span>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        27 <a class="badge bg-soft-dark text-dark ms-1" href="javascript:void(0)"
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="tasks completed today">+2</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="project.html">
                                        <img class="avatar" src="assets/svg/brands/spec-icon.svg"
                                            alt="Image Description">
                                        <div class="ms-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        19 <a class="badge bg-soft-dark text-dark ms-1" href="javascript:void(0)"
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="tasks completed today">+1</a>
                                    </div>
                                </td>
                                <td>
                                    <!-- Avatar Group -->
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="project.html">
                                        <img class="avatar" src="assets/svg/brands/jira-icon.svg"
                                            alt="Image Description">
                                        <div class="ms-3">
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        32 <a class="badge bg-soft-dark text-dark ms-1" href="javascript:void(0)"
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="tasks completed today">+5</a>
                                    </div>
                                </td>
                                <td>
                                    <!-- Avatar Group -->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        10 <a class="badge bg-soft-dark text-dark ms-1" href="javascript:void(0)"
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="task completed today">+1</a>
                                    </div>
                                </td>
                                <td>
                                    <!-- Avatar Group -->
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="project.html">
                                        <img class="avatar" src="assets/svg/brands/figma-icon.svg"
                                            alt="Image Description">
                                        <div class="ms-3">
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="project.html">
                                        <img class="avatar" src="assets/svg/brands/google-webdev-icon.svg"
                                            alt="Image Description">
                                        <div class="ms-3">
                                            <span class="d-block h5 text-inherit mb-0">Create a new database for
                                                Webdev</span>
                                            <span class="d-block fs-6 text-body">Updated 2 hours ago</span>
                                        </div>
                                    </a>
                                ...
                                <td>
                                    ...
                                    <div class="avatar-group avatar-group-xs avatar-circle">
                                        ...
                                        <a class="avatar avatar-soft-danger" href="user-profile.html"
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="Teresa Eyker">
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="project.html">
                                        ...
                                        <div class="ms-3">
                                            <span class="d-block h5 text-inherit mb-0">Marketing &amp;
                                                Communications</span>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        44 <a class="badge bg-soft-dark text-dark ms-1" href="javascript:void(0)"
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="tasks completed today">+5</a>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="project.html">
                                        <img class="avatar" src="assets/svg/brands/bookingcom-icon.svg"
                                            alt="Image Description">
                                        <div class="ms-3">
                                            <span class="d-block h5 text-inherit mb-0">Set up a datatable for
                                                Booking.com</span>
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="project.html">
                                        ...
                                        <div class="ms-3">
                                            <span class="d-block h5 text-inherit mb-0">Create a new marketing
                                                campaign</span>
                                            <span class="d-block fs-6 text-body">Updated 1 day ago</span>
                                        </div>
                                    </a>
                                ...
                                <td>
                                    ...
                                    <div class="avatar-group avatar-group-xs avatar-circle">
                                        ...
                                        <a class="avatar avatar-soft-dark" href="user-profile.html"
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="Zack Ins">
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="project.html">
                                        <img class="avatar" src="assets/svg/brands/prosperops-icon.svg"
                                            alt="Image Description">
                                        <div class="ms-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        10 <a class="badge bg-soft-dark text-dark ms-1" href="javascript:void(0)"
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="tasks completed today">+7</a>
                                    </div>
                                </td>
                                <td>No assignee</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="project.html">
                                        <img class="avatar" src="assets/svg/brands/spotify-icon.svg"
                                            alt="Image Description">
                                        <div class="ms-3">
                                            <span class="d-block h5 text-inherit mb-0">Redesigning the Spotify main
                                                page</span>
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="project.html">
                                        <img class="avatar" src="assets/svg/brands/digitalocean-icon.svg"
                                            alt="Image Description">
                                        <div class="ms-3">
                                            <span class="d-block h5 text-inherit mb-0">Working on a new Cloud
                                                computing</span>
                                            <span class="d-block fs-6 text-body">Updated 5 days ago</span>
                                        </div>
                                    </a>
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="project.html">
                                        ...
                                        <div class="ms-3">
                                            <span class="d-block h5 text-inherit mb-0">Launch social network
                                                campaign</span>
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="project.html">
                                        <img class="avatar" src="assets/svg/brands/atlassian-icon.svg"
                                            alt="Image Description">
                                        <div class="ms-3">
                            ...
                            <tr>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="project.html">
                                        <img class="avatar" src="assets/svg/brands/frontapp-icon.svg"
                                            alt="Image Description">
                                        <div class="ms-3">
                                            <span class="d-block h5 text-inherit mb-0">Increase email conversion
                                                rating</span>
                                            <span class="d-block fs-6 text-body">Updated 1 hour ago</span>
                                        </div>
                                    </a>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        9 <a class="badge bg-soft-dark text-dark ms-1" href="javascript:void(0)"
                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                            title="task completed today">+1</a>
                                    </div>
                                </td>
                ...
                <div class="modal-body">
                    ...
                    <div class="js-nav-scroller hs-nav-scroller-horizontal">
                        ...
                        <ul class="js-tabs-to-dropdown nav nav-segment nav-fill mb-5" id="editUserModalTab"
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#notifications" id="notifications-tab"
                                    data-bs-toggle="tab" data-bs-target="#notifications" role="tab"
                                    aria-selected="false">
                        ...
                        <div class="tab-pane fade show active" id="profile" role="tabpanel"
                            ...
                            <form>
                              ...
                              "allowTypes": [".png", ".jpeg", ".jpg"]
                                ...
                                <!-- Form -->
                                <div class="row mb-4">
                                    <label for="editPhoneLabel" class="col-sm-3 col-form-label form-label">Phone
                                        <span class="form-label-secondary">(Optional)</span></label>

                                    <div class="col-sm-9">
                                        <div class="input-group input-group-sm-vertical">
                                            <input type="text" class="js-masked-input form-control"
                                                name="phone" id="editPhoneLabel" placeholder="+x(xxx)xxx-xx-xx"
                        ...
                        <div class="tab-pane fade" id="billing-address" role="tabpanel"
                            ...
                            <form>
                               ...
                               "placeholder": "Select country"
                                ...
                                <!-- Form -->
                                <div class="row">
                                    <label for="editZipCodeLabel" class="col-sm-3 col-form-label form-label">Zip
                                        code <i class="bi-question-circle text-body ms-1" data-bs-toggle="tooltip"
                                            data-bs-placement="top"
                                            title="You can find your code in a postal address."></i></label>

                                    <div class="col-sm-9">
                                        <input type="text" class="js-input-mask form-control" name="zipCode"
                                            id="editZipCodeLabel" placeholder="Your zip code"
                                ...
                                <div class="d-grid gap-3">
                                    ...
                                    <label class="row form-check form-switch"
                                        ...
                                        <span class="col-8 col-sm-9 ms-0">
                                            ...
                                            <span class="d-block fs-5 text-muted">Set as default billing
                                                address</span>
                                        </span>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <label class="avatar avatar-xl avatar-circle avatar-uploader me-5"
                                            ...
                                            <img id="avatarNewProjectImg" class="avatar-img"
                                                src="assets/img/160x160/img2.jpg" alt="Image Description">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <!-- Select -->
                                            <div class="tom-select-custom">
                                                <select class="js-select form-select" id="ownerNewProjectLabel"
                                                    data-hs-tom-select-options='{
                                  "searchInDropdown": false,
                                  "hideSearch": true
                                }'>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="mb-4">
                                            <label for="milestoneNewProjectLabel" class="form-label">Milestone <a
                                                    class="small ms-1" href="javascript:void(0)">Change
                                                    probability</a></label>
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/projects.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:38:02 GMT -->
