...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ecommerce-manage-reviews.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:58 GMT -->
                        ...
                        <div id="navbarVerticalMenuPagesMenu">
                            ...
                            <div class="nav-item">
                                ...
                                <div id="navbarVerticalMenuPagesEcommerceMenu" class="nav-collapse collapse show"
                                    ...
                                    <a class="nav-link active" href="ecommerce-manage-reviews.html">Manage Reviews</a>
                        ...
                        <div class="col-md-auto mb-3 mb-md-0">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-5">
                                    ...
                                    <p>&mdash; of 7 reviews <span
                                            class="badge bg-soft-dark text-dark rounded-pill ms-1">+1 this week</span>
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <th>
                                    <a class="d-flex align-items-center" href="user-profile.html">
                                        <div class="avatar">
                                            <img class="avatar-img" src="assets/img/400x400/img18.jpg"
                                                alt="Image Description">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                ...
                                <td>
                                    <a class="d-flex align-items-center" href="user-profile.html">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <span class="card-title h5 text-inherit">Amanda Harvey <i
                                                    class="bi-patch-check-fill text-primary"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="Verified purchase"></i></span>
                                ...
                                <td>
                                    <div class="text-wrap" style="width: 18rem;">
                                        ...
                                        <p>I bought this hat for my boyfriend, but then i found out he cheated on me so
                                            I kept it and I love it!! I wear it all the time and there is no problem
                                            with the fit even though its a mens" hat.</p>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <th>
                                    <a class="d-flex align-items-center" href="user-profile.html">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <span class="card-title h5 text-dark text-inherit">Calvin Klein
                                                t-shirts</span>
                                        </div>
                                    </a>
                                </th>
                                ...
                                <td>
                                    ...
                                    <div class="hs-unfold">
                                        <button type="button"
                                            class="btn btn-ghost-secondary btn-icon btn-sm rounded-circle"
                                            id="settingsDropdown2" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <i class="bi-three-dots-vertical"></i>
                                        </button>
                            ...
                            <tr>
                                ...
                                <th>
                                    <a class="d-flex align-items-center" href="user-profile.html">
                                        <div class="avatar">
                                            <img class="avatar-img" src="assets/img/400x400/img24.jpg"
                                                alt="Image Description">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                ...
                                <td>
                                    <div class="text-wrap" style="width: 18rem;">
                                        ...
                                        <p>A really well built shoe. It looks great and wears just as well. A great
                                            staple in ball caps.</p>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <div class="hs-unfold">
                                        <button type="button"
                                            class="btn btn-ghost-secondary btn-icon btn-sm rounded-circle"
                                            id="settingsDropdown3" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <i class="bi-three-dots-vertical"></i>
                                        </button>
                            ...
                            <tr>
                                ...
                                <th>
                                    <a class="d-flex align-items-center" href="user-profile.html">
                                        <div class="avatar">
                                            <img class="avatar-img" src="assets/img/400x400/img19.jpg"
                                                alt="Image Description">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <span class="card-title h5 text-dark text-inherit">Levis women's
                                                jeans</span>
                                        </div>
                                    </a>
                                </th>
                                ...
                                <td>
                                    <div class="text-wrap" style="width: 18rem;">
                                        ...
                                        <p>Don't let this merchandise get away! It's a must buy and you will look good
                                            in it while working out.</p>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <div class="hs-unfold">
                                        <button type="button"
                                            class="btn btn-ghost-secondary btn-icon btn-sm rounded-circle"
                                            id="settingsDropdown4" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <i class="bi-three-dots-vertical"></i>
                                        </button>

                                        <div class="dropdown-menu dropdown-menu-end mt-1"
                                            aria-labelledby="settingsDropdown4">
                                            <span class="dropdown-header">Settings</span>
                            ...
                            <tr>
                                ...
                                <th>
                                    <a class="d-flex align-items-center" href="user-profile.html">
                                        <div class="avatar">
                                            <img class="avatar-img" src="assets/img/400x400/img11.jpg"
                                                alt="Image Description">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                ...
                                <td>
                                    <div class="text-wrap" style="width: 18rem;">
                                        ...
                                        <p>As good as the heat Rdy T-shirt but without the sleeves. Love the stripes on
                                            the back.</p>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <div class="hs-unfold">
                                        <button type="button"
                                            class="btn btn-ghost-secondary btn-icon btn-sm rounded-circle"
                                            id="settingsDropdown5" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <i class="bi-three-dots-vertical"></i>
                                        </button>

                                        <div class="dropdown-menu dropdown-menu-end mt-1"
                                            aria-labelledby="settingsDropdown5">
                                            <span class="dropdown-header">Settings</span>
                            ...
                            <tr>
                                ...
                                <th>
                                    <a class="d-flex align-items-center" href="user-profile.html">
                                        <div class="avatar">
                                            <img class="avatar-img" src="assets/img/400x400/img7.jpg"
                                                alt="Image Description">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <span class="card-title h5 text-dark text-inherit">Tiro track
                                                jacket</span>
                                        </div>
                                    </a>
                                </th>
                                <td>
                                    <a class="d-flex align-items-center" href="user-profile.html">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <span class="card-title h5 text-dark text-inherit">Ella Lauda <i
                                                    class="bi-patch-check-fill text-primary"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="Top endorsed"></i></span>
                                ...
                                <td>
                                    <div class="text-wrap" style="width: 18rem;">
                                        ...
                                        <p>Great quality, it is a loose fitting but I would recommend going one size
                                            smaller as normal. I always prefer bigger size so bought large for me. Love
                                            the pride vibes!!!</p>
                                    </div>
                                </td>
                                <td>June 08, 2020, 07:22</td>
                                ...
                                <td>
                                    ...
                                    <div class="hs-unfold">
                                        <button type="button"
                                            class="btn btn-ghost-secondary btn-icon btn-sm rounded-circle"
                                            id="settingsDropdown6" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <i class="bi-three-dots-vertical"></i>
                                        </button>

                                        <div class="dropdown-menu dropdown-menu-end mt-1"
                                            aria-labelledby="settingsDropdown6">
                                            <span class="dropdown-header">Settings</span>
                            ...
                            <tr>
                                ...
                                <th>
                                    <a class="d-flex align-items-center" href="user-profile.html">
                                        <div class="avatar">
                                            <img class="avatar-img" src="assets/img/400x400/img14.jpg"
                                                alt="Image Description">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                ...
                                <td>
                                    <a class="d-flex align-items-center" href="user-profile.html">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <span class="card-title h5 text-dark text-inherit">Lori Hunter <i
                                                    class="bi-patch-check-fill text-primary"
                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                    title="Top endorsed"></i></span>
                                ...
                                <td>
                                    <div class="text-wrap" style="width: 18rem;">
                                        ...
                                        <p>I am very pleased with my purchase. I have started to have my friends become
                                            addicted to Air Jordans also.</p>
                                    </div>
                                </td>
                                ...
                                <td>
                                    ...
                                    <div class="hs-unfold">
                                        <button type="button"
                                            class="btn btn-ghost-secondary btn-icon btn-sm rounded-circle"
                                            id="settingsDropdown7" data-bs-toggle="dropdown"
                                            aria-expanded="false">
                                            <i class="bi-three-dots-vertical"></i>
                                        </button>

                                        <div class="dropdown-menu dropdown-menu-end mt-1"
                                            aria-labelledby="settingsDropdown7">
                                            <span class="dropdown-header">Settings</span>
