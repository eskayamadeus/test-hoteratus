<x-base-layout>
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            ...
            <h1 class="page-header-title">Reservation List</h1>
          </div>
          <!-- End Col -->

                <div class="col-sm-auto">
                    <a class="btn btn-primary" href="{{ route('make-reservations') }}">
                        <i class="bi-person-plus-fill me-1"></i>ADD RESERVATIONS
                    </a>
                </div>
                <!-- End Col -->
            </div>
                    ...
                    <form>
                        ...
                        <div class="input-group input-group-merge input-group-flush">
                            ...
                            <input id="datatableSearch" type="search" class="form-control"
                                placeholder="Search Reservations" aria-label="Search Reservations">
                        </div>
                        <!-- End Search -->
                    </form>
                </div>
                    ...
                    <tbody>
                        @foreach ( $reservations as $reserve)
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="d-block h5 mb-0">00000000</span>
                                ...
                                <td class="table-column-ps-0">
                                    <a class="d-flex align-items-center" href="">
                                        ...
                                        <div class="ms-3">
                                            <span class="d-block h5 text-inherit mb-0">{{ $reserve->f_name}} {{ $reserve->l_name }}</span>
                                ...
                                <td>
                                    <span class=""></span>Standard Room
                                </td>

                                <td>
                                    <div class="d-flex align-items-center">
                                        <span class="fs-5 me-2">43,000</span>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title" id="staticBackdropLabel">Search Rooms</h2>
                          ...
                          <div class="col-sm-9">
                            <div class="d-flex align-items-center">
                              ...
                              <button type="button" class="js-file-attach-reset-img btn btn-white">Delete</button>
                                ...
                                <!-- Form -->
                                <div class="row mb-4">
                                    <label for="firstNameLabel" class="col-sm-3 col-form-label form-label">Check-In
                                    </label>
                                ...
                                <div class="row mb-4">
                                    <label for="firstNameLabel" class="col-sm-3 col-form-label form-label">Check-Out
                                    </label>
                                ...
                                <!-- Form -->
                                <div class="row mb-4">
                                    <label for="emailLabel" class="col-sm-3 col-form-label form-label">Rooms</label>
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="organization"
                                            id="organizationLabel" placeholder="Htmlstream"
