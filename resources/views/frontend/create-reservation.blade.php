<x-base-layout>
    ...
    <!-- Content -->
    <div class="content container-fluid wizard-card">
        <!-- Page Header -->
                ...
                <div class="page-header">
                    <ul class="list-group col-auto">
                        <li class="list-group-item active">
                          <i class="bi-house list-group-icon"></i> Reservations
                        </li>

                      </ul>

                      <div class="card-header card-header-content-md-between">
                        {{-- <h5 class="card-header-title">Check-In</h5> --}}
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-4">
                          ...
                          <div class="js-sortable sortablejs-custom list-group"
                               ...
                               <ul class="list-group">
                                <li class="list-group-item active">
                                  <i class="bi-house list-group-icon"></i> Booking Details
                                </li>
                                <li class="list-group-item">
                                  <i class="bi-person list-group-icon"></i> Check-In : <span style="font-weight:bold">12/02/2024</span>
                                </li>
                                <li class="list-group-item">
                                  <i class="bi-list-task list-group-icon"></i> Check-Out :<span style="font-weight:bold">13/02/2024</span>
                                </li>
                                <li class="list-group-item">
                                  <i class="bi-layers list-group-icon"></i> Room Selected : <span style="font-weight:bold">7 Bedroom Villa</span>
                                </li>
                                <li class="list-group-item">
                                  <i class="bi-people list-group-icon"></i> Number of Guests : <span style="font-weight:bold">1</span>
                                </li>
                                <li class="list-group-item">
                                    <i class="bi-people list-group-icon"></i> Number of Children : <span style="font-weight:bold">0</span>
                                  </li>
                                  <li class="list-group-item">
                                    <i class="bi-people list-group-icon"></i> Arrival : <span style="font-weight:bold">12/02/2024</span>
                                  </li>
                                  {{-- <li class="list-group-item">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="js-sortable sortablejs-custom list-group"
                                 ...
                                 <ul class="list-group">
                                  <li class="list-group-item active">
                                    <i class="bi-house list-group-icon"></i> Create Reservations
                                  </li>
                                   <li class="list-group-item">
                                  <form id="regForm" action="{{ route('c-reservations') }}" method="POST">
                                    @csrf
                                    <div class="tab"><h3>Main Guest Information</h3>
                                        <p><input name="f_name" placeholder="First name..." oninput="this.className = ''" required></p>
                                        <p><input name="l_name" placeholder="Last name..." oninput="this.className = ''" required></p>
                                        <p><input name="phone_number" placeholder="Phone Number" oninput="this.className = ''" required></p>
                                        <p><input name="email" placeholder="Email" oninput="this.className = ''" required></p>
                                        <div class="form-check form-switch mb-4">
                                            <input type="checkbox" class="form-check-input" id="formSwitch1">
                                            <label class="form-check-label" for="formSwitch1">Send Mail</label>
                                          </div>
                                        <h4>Guest Information</h4>
                                        <p><input name="g_fname" placeholder="Guest First Name" ></p>
                                        <p><input name="g_lname" placeholder="Guest Last Name" ></p>


                                      </div>

                                      <div class="tab"><h3>Address Information</h3>
                                        <p><textarea name="address" id="" cols="30" rows="5"></textarea></p>
                                        <p><select name="country" cols="30" rows="2" oninput="this.className = ''"  id="locationLabel">
                                        ...
                                        <p><input name="state" oninput="this.className = ''" type="text" placeholder="State" name="" id=""></p>
                                        <p><input name="city" oninput="this.className = ''" type="text" placeholder="City" name="" id=""></p>
                                        <p><input name="language" oninput="this.className = ''" type="text" placeholder="Language" name="" id=""></p>
                                      </div>

                                      <div class="tab"><h3>Payment Option</h3>
                                        <select name="payment_method" oninput="this.className = ''" class="js-select form-select" id="locationLabel">
