...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/project-teams.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:38:06 GMT -->
            ...
            <div class="card">
                ...
                <div class="card-header card-header-content-md-between">
                    ...
                    <div class="d-grid d-sm-flex align-items-sm-center gap-2">
                        ...
                        <a class="btn btn-white dropdown-toggle" data-bs-toggle="collapse"
                            href="#filterSearchCollapse" role="button" aria-expanded="false"
                        ...
                        <form>
                            <div class="row">
                                <div class="col-sm-12 col-lg-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input class="form-control" id="teamsFilterLabel"
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="tom-select-custom tom-select-custom-with-tags">
                                            <select class="js-select form-select" id="tagsFilterLabel"
                                ...
                                <div class="col-sm-12 col-md-6 col-lg-4">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <div class="tom-select-custom">
                                            <select class="js-select form-select" id="ratingFilterLabel"
                                                autocomplete="off" multiple
                                                data-hs-tom-select-options='{
                                "singleMultiple": true,
                                "hideSelected": false,
                                "placeholder": "Select rating"
                                                ...
                                                <option value="rating1"
                                                    data-option-template='<div class="d-flex gap-1">
                   ...
                   "pagination": "datatablePagination"
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Our group promotes and sells products and services by leveraging online marketing
                                    tactics</td>
                                <td><a class="badge bg-soft-primary text-primary p-2" href="#">Marketing
                                        team</a></td>
                                <td>
                                    <div class="d-flex gap-1">
                                        ...
                                        <img src="assets/svg/illustrations/star.svg" alt="Review rating"
                                            width="14">
                                        <img src="assets/svg/illustrations/star-half.svg" alt="Review rating"
                                            width="14" data-hs-theme-appearance="default">
                                        <img src="assets/svg/illustrations-light/star-half.svg" alt="Review rating"
                                            width="14" data-hs-theme-appearance="dark">
                                    </div>
                                </td>
                                <td>
                                    <div class="avatar-group avatar-group-xs avatar-circle">
                                        ...
                                        <span class="avatar avatar-soft-dark" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="Antony Taylor">
                                            <span class="avatar-initials">A</span>
                                        </span>
                                        <span class="avatar avatar-soft-info" data-bs-toggle="tooltip"
                                        ...
                                        <span class="avatar avatar-light avatar-circle" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="Sam Kart, Amanda Harvey and 1 more">
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm" id="teamsDropdown1"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        ...
                                        <img src="assets/svg/illustrations/star.svg" alt="Review rating"
                                            width="14">
                                        <img src="assets/svg/illustrations/star-muted.svg" alt="Review rating"
                                            width="14" data-hs-theme-appearance="default">
                                        <img src="assets/svg/illustrations-light/star-muted.svg" alt="Review rating"
                                            width="14" data-hs-theme-appearance="dark">
                                    </div>
                                </td>
                                <td>
                                    <div class="avatar-group avatar-group-xs avatar-circle">
                                        ...
                                        <span class="avatar avatar-soft-danger" data-bs-toggle="tooltip"
                                        ...
                                        <span class="avatar avatar-soft-warning" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="Olivier L.">
                                            <span class="avatar-initials">O</span>
                                        </span>
                                        <span class="avatar avatar-light avatar-circle" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="Brian Halligan, Rachel Doe and 7 more">
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm" id="teamsDropdown2"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            More <i class="bi-chevron-down ms-1"></i>
                                        </button>
                            ...
                            <tr>
                                ...
                                <td><a class="badge bg-soft-info text-info p-2" href="#">Marketing team</a>
                                </td>
                                <td>
                                    <div class="d-flex gap-1">
                                        <img src="assets/svg/illustrations/star.svg" alt="Review rating"
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm" id="teamsDropdown3"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            More <i class="bi-chevron-down ms-1"></i>
                                        </button>
                            ...
                            <tr>
                                ...
                                <td><a class="badge bg-soft-danger text-danger p-2" href="#">Customer
                                        service</a></td>
                                <td>
                                    <div class="d-flex gap-1">
                                        <img src="assets/svg/illustrations/star.svg" alt="Review rating"
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm" id="teamsDropdown4"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            More <i class="bi-chevron-down ms-1"></i>
                                        </button>
                            ...
                            <tr>
                                ...
                                <td>This group serves online money transfers as an electronic alternative to paper
                                    methods</td>
                                <td><a class="badge bg-soft-primary text-primary p-2" href="#">Online
                                        payment</a></td>
                                <td>
                                    <div class="d-flex gap-1">
                                        <img src="assets/svg/illustrations/star.svg" alt="Review rating"
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm" id="teamsDropdown5"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            More <i class="bi-chevron-down ms-1"></i>
                                        </button>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm" id="teamsDropdown6"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            More <i class="bi-chevron-down ms-1"></i>
                                        </button>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="avatar-group avatar-group-xs avatar-circle">
                                        ...
                                        <span class="avatar avatar-soft-primary" data-bs-toggle="tooltip"
                                            data-bs-placement="top" title="Daniel Cs.">
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm" id="teamsDropdown7"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            More <i class="bi-chevron-down ms-1"></i>
                                        </button>
                            ...
                            <tr>
                                ...
                                <td>Software testers play a critical role in application development. They are quality
                                    assurance experts who put applications</td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm" id="teamsDropdown8"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            More <i class="bi-chevron-down ms-1"></i>
                                        </button>

                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-end"
                                            aria-labelledby="teamsDropdown8">
                                            <a class="dropdown-item" href="#">Rename team</a>
                                            <a class="dropdown-item" href="#">Add to favorites</a>
                                            <a class="dropdown-item" href="#">Archive team</a>
                                            <div class="dropdown-divider"></div>
                            ...
                            <tr>
                                ...
                                <td>Managing a sales team is no easy task. You have the potential to either make or
                                    break your sales reps.</td>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm" id="teamsDropdown9"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            More <i class="bi-chevron-down ms-1"></i>
                                        </button>

                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-end"
                                            aria-labelledby="teamsDropdown9">
                                            <a class="dropdown-item" href="#">Rename team</a>
                                            <a class="dropdown-item" href="#">Add to favorites</a>
                                            <a class="dropdown-item" href="#">Archive team</a>
                                            <div class="dropdown-divider"></div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm" id="teamsDropdown10"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            More <i class="bi-chevron-down ms-1"></i>
                                        </button>

                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-end"
                                            aria-labelledby="teamsDropdown10">
                                            <a class="dropdown-item" href="#">Rename team</a>
                                            <a class="dropdown-item" href="#">Add to favorites</a>
                                            <a class="dropdown-item" href="#">Archive team</a>
                                            <div class="dropdown-divider"></div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm" id="teamsDropdown11"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            More <i class="bi-chevron-down ms-1"></i>
                                        </button>

                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-end"
                                            aria-labelledby="teamsDropdown11">
                                            <a class="dropdown-item" href="#">Rename team</a>
                                            <a class="dropdown-item" href="#">Add to favorites</a>
                                            <a class="dropdown-item" href="#">Archive team</a>
                                            <div class="dropdown-divider"></div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
                                        <button type="button" class="btn btn-white btn-sm" id="teamsDropdown12"
                                            data-bs-toggle="dropdown" aria-expanded="false">
                                            More <i class="bi-chevron-down ms-1"></i>
                                        </button>

                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-end"
                                            aria-labelledby="teamsDropdown12">
                                            <a class="dropdown-item" href="#">Rename team</a>
                                            <a class="dropdown-item" href="#">Add to favorites</a>
                                            <a class="dropdown-item" href="#">Archive team</a>
                                            <div class="dropdown-divider"></div>
