...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ecommerce-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:58 GMT -->
            ...
            <form class="js-step-form"
              ...
              "isValidate": false
                ...
                <div class="w-md-75 mx-md-auto">
                    <!-- Step -->
                    <ul id="checkoutStepFormProgress"
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <div class="avatar avatar-lg">
                                                <img class="avatar-img" src="assets/img/400x400/img26.jpg"
                                                    alt="Image Description">
                                                <span
                                                    class="avatar-status avatar-lg-status avatar-status-primary">1</span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <div class="avatar avatar-lg">
                                                <img class="avatar-img" src="assets/img/400x400/img3.jpg"
                                                    alt="Image Description">
                                                <span
                                                    class="avatar-status avatar-lg-status avatar-status-primary">2</span>
                                            </div>
                                        </div>
                    ...
                    <div class="col-lg-8">
                        <div id="checkoutStepFormContent">
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <!-- Form -->
                                                <div class="mb-4">
                                                    <label for="firstNameDeliveryAddressLabel"
                                                        class="form-label">First name</label>
                                                    <input type="text" class="form-control"
                                                        name="firstNameDeliveryAddress"
                                                        id="firstNameDeliveryAddressLabel" placeholder="Clarice"
                                                        aria-label="Clarice">
                                                </div>
                                                <!-- End Form -->
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                <!-- Form -->
                                                <div class="mb-4">
                                                    <label for="lastNameDeliveryAddressLabel"
                                                        class="form-label">Last name</label>
                                                    <input type="text" class="form-control"
                                                        name="lastNameDeliveryAddress"
                                                        id="lastNameDeliveryAddressLabel" placeholder="Boone"
                                                        aria-label="Boone">
                                                </div>
                                                <!-- End Form -->
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <!-- Form -->
                                                <div class="mb-4">
                                                    <label for="emailDeliveryAddressLabel"
                                                        class="form-label">Email</label>
                                                    <input type="text" class="form-control"
                                                        name="emailDeliveryAddress" id="emailDeliveryAddressLabel"
                                                        placeholder="clarice@gmail.com"
                                                        aria-label="clarice@gmail.com">
                                                </div>
                                                <!-- End Form -->
                                            </div>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" class="js-input-mask form-control"
                                                        name="phoneDeliveryName" id="phoneDeliveryLabel"
                                   ...
                                   "mask": "+0(000)000-00-00"
                                        ...
                                        <div class="row">
                                            <div class="col-sm-8">
                                                <!-- Form -->
                                                <div class="mb-4">
                                                    <label for="deliveryStreetAddressLabel"
                                                        class="form-label">Street address</label>
                                                    <input type="text" class="form-control"
                                                        name="deliveryStreetAddress" id="deliveryStreetAddressLabel"
                                                        placeholder="470, Lucy Forks Street"
                                                        aria-label="470, Lucy Forks Street">
                                                </div>
                                                <!-- End Form -->
                                            </div>
                                            ...
                                            <div class="col-sm-4">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" class="form-control" name="deliveryUnit"
                                                        id="deliveryUnitLabel" placeholder="10" aria-label="10">
                                                </div>
                                                <!-- End Form -->
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" name="deliveryCity"
                                                id="deliveryCityLabel" placeholder="London" aria-label="London">
                                        </div>
                                        <!-- End Form -->
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <!-- Select -->
                                                <div class="mb-4">
                                                    <label for="billingCountryLabel"
                                                        class="form-label">Country</label>

                                                    <!-- Select -->
                                                    <div class="tom-select-custom">
                                                        <select class="js-select form-select"
                                                            id="billingCountryLabel">
                                                            <option value="AF"
                                            ...
                                            <div class="col-sm-6">
                                                <!-- Form -->
                                                <div class="mb-4">
                                                    <label for="DeliveryZipCodeLabel" class="form-label">Zip code <i
                                                            class="bi-question-circle text-body ms-1"
                                                            data-bs-toggle="tooltip" data-bs-placement="top"
                                                            title="You can find your code in a postal address."></i></label>

                                                    <input type="text" class="js-input-mask form-control"
                                                        name="DeliveryZipCode" id="DeliveryZipCodeLabel"
                                                        placeholder="SE7 5QY" aria-label="SE7 5QY"
                                                        data-hs-mask-options='{
                                   "mask": "AA0 0AA"
                                 }'>
                                                </div>
                                        ...
                                        <div class="form-check mb-4">
                                            <input type="checkbox" class="form-check-input"
                                                id="exclusiveOffersCardCheckbox1">
                                            <label class="form-check-label"
                                                for="exclusiveOffersCardCheckbox1">Please send me emails with
                                        ...
                                        <div class="d-grid gap-3">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="deliveryOptionRadio" value=""
                                                    id="deliveryOptionRadio1" checked>
                                                <label class="form-check-label" for="deliveryOptionRadio1">
                                                    <span class="d-block fw-semibold mb-1">Standard Delivery</span>
                                                    <span class="d-block">Delivered on or before Friday, 28 August,
                                                        2020</span>
                                                    <span class="d-block">Delivery is excluded on Public
                                                        Holidays.</span>
                                                </label>
                                            </div>
                                            <!-- End Form Check -->
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio"
                                                    name="deliveryOptionRadio" value=""
                                                    id="deliveryOptionRadio2">
                                                <label class="form-check-label" for="deliveryOptionRadio2">
                                                    <span class="d-block fw-semibold mb-1">$9.99 - Next-day
                                                        delivery</span>
                                                    <span class="d-block">Delivered between 7am and 10pm on Wednesday,
                                                        26 August, 2020</span>
                                                </label>
                                            </div>
                                            <!-- End Form Check -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="btn-group-sm-vertical">
                                            <div class="btn-group btn-group-segment btn-group-fill mb-4"
                                                role="group" aria-label="Status radio button group">
                                                <input type="radio" class="btn-check flex-fill"
                                                    name="ecommerceCheckoutBtnRadio"
                                                    id="ecommerceCheckoutBtnRadioCreditCard" autocomplete="off"
                                                    checked>
                                                ...
                                                <input type="radio" class="btn-check flex-fill"
                                                    name="ecommerceCheckoutBtnRadio"
                                                    id="ecommerceCheckoutBtnRadioPayPal" autocomplete="off"
                                                    disabled>
                                                <label class="btn btn-sm" for="ecommerceCheckoutBtnRadioPayPal">
                                                    <img class="avatar avatar-xss avatar-4x3 me-2"
                                                        src="assets/svg/brands/paypal-icon.svg"
                                                        alt="Image Description">
                                                    PayPal <span class="badge bg-soft-primary text-primary">Coming
                                                        soon</span>
                                                </label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="form-control" id="cardNameLabel"
                                                placeholder="Payoneer" aria-label="Payoneer">
                                        </div>
                                        <!-- End Form -->
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="text" class="js-input-mask form-control"
                                                ...
                                                placeholder="xxxx xxxx xxxx xxxx" aria-label="xxxx xxxx xxxx xxxx"
                                                data-hs-mask-options='{
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="mb-4">
                                                    <label for="expirationDateLabel" class="form-label">Expiration
                                                        date</label>
                                                    <input type="text" class="js-input-mask form-control"
                                                        name="expirationDate" id="expirationDateLabel"
                                                        placeholder="xx/xxxx" aria-label="xx/xxxx"
                                                        data-hs-mask-options='{
                                  "mask": "00/0000"
                                }'>
                                                </div>
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" class="js-input-mask form-control"
                                                        name="securityCode" id="securityCodeLabel"
                                                        placeholder="xxx" aria-label="xxx"
                                                        data-hs-mask-options='{
                                  "mask": "000"
                                }'>
                                                </div>
                                ...
                                <div class="card mb-3 mb-lg-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <span class="d-block text-dark">MasterCard &bull;&bull;&bull;&bull;
                                                    4242</span>
                            ...
                            "targetSelector": "#checkoutStepPayment"
                                    ...
                                    <div class="ms-auto">
                                        <button id="checkoutFinishBtn" type="button"
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ecommerce-checkout.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:59 GMT -->
