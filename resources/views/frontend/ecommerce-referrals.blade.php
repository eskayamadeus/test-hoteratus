...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ecommerce-referrals.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:57 GMT -->
                        ...
                        <div id="navbarVerticalMenuPagesMenu">
                            ...
                            <div class="nav-item">
                                ...
                                <div id="navbarVerticalMenuPagesEcommerceMenu" class="nav-collapse collapse show"
                                    ...
                                    <a class="nav-link active" href="ecommerce-referrals.html">Referrals</a>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-6 col-md-5 col-lg-4">
                        ...
                        <div class="input-group">
                            <input id="referralCode" type="text" class="form-control" readonly
                                value="https://htmlstream.com/wer9n8x">
                            <div class="input-group-append">
                                <a class="js-clipboard btn btn-white" href="javascript:void(0)"
            ...
            <div class="row col-lg-divider">
                <div class="col-lg-4">
                    ...
                    <div class="text-center">
                        ...
                        <img class="avatar avatar-xl avatar-4x3 mb-4"
                            src="assets/svg/illustrations-light/oc-megaphone.svg" alt="Image Description"
                ...
                <div class="col-lg-4">
                    ...
                    <div class="text-center">
                        <img class="avatar avatar-xl avatar-4x3 mb-4"
                            src="assets/svg/illustrations/oc-money-profits.svg" alt="Image Description"
                            data-hs-theme-appearance="default" style="min-height: 6rem;">
                        <img class="avatar avatar-xl avatar-4x3 mb-4"
                ...
                <div class="col-lg-4">
                    <!-- Card -->
                    <div class="text-center">
                        <img class="avatar avatar-xl avatar-4x3 mb-4" src="assets/svg/illustrations/oc-growing.svg"
                            alt="Image Description" data-hs-theme-appearance="default" style="min-height: 6rem;">
                        <img class="avatar avatar-xl avatar-4x3 mb-4"
                            src="assets/svg/illustrations-light/oc-growing.svg" alt="Image Description"
                            data-hs-theme-appearance="dark" style="min-height: 6rem;">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mb-3 mb-lg-5">
                    ...
                    <div class="card h-100">
                        <!-- Header -->
                        <div class="card-header card-header-content-between">
                            <h4 class="card-header-title">Your top countries <i
                                    class="bi-patch-check-fill text-primary" data-bs-toggle="tooltip"
                                    data-bs-placement="top" title="This report is based on 100% of sessions."></i>
                            </h4>
                            ...
                            <div class="list-group list-group-flush list-group-no-gutters">
                                ...
                                <div class="list-group-item">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img class="avatar avatar-xss avatar-circle"
                                                src="assets/vendor/flag-icon-css/flags/1x1/fr.svg" alt="Flag">
                                        </div>
                                ...
                                <div class="list-group-item">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img class="avatar avatar-xss avatar-circle"
                                                src="assets/vendor/flag-icon-css/flags/1x1/ca.svg" alt="Flag">
                                        </div>
                   ...
                   "pagination": "datatablePagination"
                            ...
                            <tr>
                                    ...
                                    <a class="d-flex align-items-center" href="user-profile.html">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <span class="d-block h5 text-inherit mb-0">Amanda Harvey <i
                                                    class="bi-question-circle text-primary" data-bs-toggle="tooltip"
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode1" type="text" class="form-control" readonly
                                            value="https://htmlstream.com/wer9n8x">
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode2" type="text" class="form-control" readonly
                                            value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode3" type="text" class="form-control" readonly
                                            value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode4" type="text" class="form-control" readonly
                                            value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode5" type="text" class="form-control" readonly
                                            value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                            ...
                            <tr>
                                <td>
                                    <a class="d-flex align-items-center" href="user-profile.html">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <span class="d-block h5 text-inherit mb-0">Ella Lauda <i
                                                    class="bi-question-circle text-primary" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="Top endorsed"></i></span>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode6" type="text" class="form-control" readonly
                                            value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode7" type="text" class="form-control" readonly
                                            value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode8" type="text" class="form-control" readonly
                                            value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode9" type="text" class="form-control" readonly
                                            value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                            ...
                            <tr>
                                <td>
                                    <a class="d-flex align-items-center" href="user-profile.html">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            <span class="d-block h5 text-inherit mb-0">Rachel Doe <i
                                                    class="bi-question-circle text-primary" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="Top endorsed"></i></span>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode10" type="text" class="form-control"
                                            readonly value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                                            data-hs-clipboard-options='{
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode11" type="text" class="form-control"
                                            readonly value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode12" type="text" class="form-control"
                                            readonly value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode13" type="text" class="form-control"
                                            readonly value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode14" type="text" class="form-control"
                                            readonly value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode15" type="text" class="form-control"
                                            readonly value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode16" type="text" class="form-control"
                                            readonly value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode17" type="text" class="form-control"
                                            readonly value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode18" type="text" class="form-control"
                                            readonly value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode19" type="text" class="form-control"
                                            readonly value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode20" type="text" class="form-control"
                                            readonly value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode21" type="text" class="form-control"
                                            readonly value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode22" type="text" class="form-control"
                                            readonly value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode23" type="text" class="form-control"
                                            readonly value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode24" type="text" class="form-control"
                                            readonly value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
                        ...
                        "successClass": "bi-check"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="input-group input-group-sm input-group-merge table-input-group">
                                        <input id="referralsKeyCode25" type="text" class="form-control"
                                            readonly value="https://htmlstream.com/wer9n8x">
                                        <a class="js-clipboard input-group-append input-group-text"
                                            href="javascript:void(0)" data-bs-toggle="tooltip"
                                            title="Copy to clipboard"
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/ecommerce-referrals.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 31 Jan 2024 15:37:58 GMT -->
