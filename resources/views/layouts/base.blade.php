...
<body class="has-navbar-vertical-aside navbar-vertical-aside-show-xl   footer-offset">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="hs-has-sub-menu nav-item">
                                    ...
                                    <div class="hs-sub-menu dropdown-menu navbar-dropdown-menu-borderless"
                                        ...
                                        <a class="dropdown-item active" href="{{ route('index') }}">Default</a>
                                ...
                                <li class="nav-item">
                                    <a class="nav-link " href="layouts/{{ route('index') }}">
                                        <i class="bi-grid-1x2 dropdown-item-icon"></i> Layouts
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a class="nav-link " href="documentation/{{ route('index') }}"
                                        data-placement="left">
                                 ...
                                 "activeClass": "focus"
                                        ...
                                        <div id="searchDropdownMenu"
                                            ...
                                            <div class="card">
                                                ...
                                                <!-- Footer -->
                                                <a class="card-footer text-center" href="{{ route('index') }}">
                                                    ...
                                                    <div class="card-header card-header-content-between">
                                                        ...
                                                        <div class="dropdown">
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu-borderless"
                                                                ...
                                                                <a class="dropdown-item" href="#">
                                                                    <i class="bi-gift dropdown-item-icon"></i> Whats
                                                                    new?
                                                                </a>
                                                                <div class="dropdown-divider"></div>
                                                                <span class="dropdown-header">Feedback</span>
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasActivityStream"
        ...
        <div class="offcanvas-header">
            <h4 id="offcanvasActivityStreamLabel" class="mb-0"><i class="bi-house nav-icon"> </i>My Properties
            </h4>
            <button type="button" class="btn-close" data-bs-dismiss="offcanvas" aria-label="Close"></button>
        </div>
        <div class="offcanvas-body">
                        ...
                        <div class="col-auto">
                            <a class="d-flex align-items-center small text-body" href="#">
                                <img class="avatar avatar-xss avatar-4x3 me-2"
                                    src="assets/svg/brands/gmail-icon.svg" alt="Image Description"> Import contacts
                            </a>
                        </div>
                    </div>
