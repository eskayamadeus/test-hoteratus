    ...
    <div class="navbar-nav-wrap">
            ...
            <div class="dropdown ms-2">
                ...
                <div class="d-none d-lg-block">
                    <div
                        ...
                        <input type="search" class="js-form-search form-control" placeholder="Search keywords..."
                    ...
                    <div class="card">
                        ...
                        <div class="card-body-height">
                            ...
                            <a class="dropdown-item" href="index.html">
                                <div class="d-flex align-items-center">
                                    <div class="flex-shrink-0">
                                        <img class="avatar avatar-xs avatar-circle" src="{{ asset('assets/svg/logos/logo.png') }}"
        ...
        <div class="navbar-nav-wrap-content-end">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <!-- Activity -->
                    <button class="btn btn-primary btn-icon rounded-circle" type="button"
                ...
                <li class="nav-item">
                    <!-- Account -->
                    <div class="dropdown">
                        <a class="navbar-dropdown-account-wrapper" href="javascript:void(0)" style="border: 1px solid #e1e1e1 !important"
                            id="accountNavbarDropdown" data-bs-toggle="dropdown" aria-expanded="false"
                            data-bs-auto-close="outside" data-bs-dropdown-animation>
                            <div class="avatar avatar-sm avatar-circle">
                                <img class="avatar-img" src="{{ asset('assets/svg/logos/fav.png') }}" alt="Image Description">
                        ...
                        <div class="dropdown-menu dropdown-menu-end navbar-dropdown-menu navbar-dropdown-menu-borderless navbar-dropdown-account"
                            ...
                            <div class="dropdown-item-text">
                                <div class="d-flex align-items-center">
                                    {{--  <div class="avatar avatar-sm avatar-circle">
                                        <img class="avatar-img" src="{{ asset('assets/svg/logos/fav.png') }}"
                                            alt="Image Description">
                                    </div>  --}}
